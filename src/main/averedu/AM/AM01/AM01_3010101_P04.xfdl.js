(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cboSearchGyeyakje","354","36","90","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("21");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_readonly("true");
            var divSearch_form_cboSearchGyeyakje_innerdataset = new nexacro.NormalDataset("divSearch_form_cboSearchGyeyakje_innerdataset", obj);
            divSearch_form_cboSearchGyeyakje_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">계약제</Col></Row><Row><Col id=\"codecolumn\">0</Col><Col id=\"datacolumn\">정규직</Col></Row></Rows>");
            obj.set_innerdataset(divSearch_form_cboSearchGyeyakje_innerdataset);
            obj.set_text("");
            obj.set_value("1");
            obj.set_index("0");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("stc_12_00_00_02_01_00_00_00","250","369","110","28",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("발령종료일");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);
            ...
            obj = new Calendar("calBalryeongToDt","362","372","126","22",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            ...
            obj = new Static("stc_12_01","490","369","110","28",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("보직명");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);

            obj = new Combo("cboBojik","602","372","126","22",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            ...
            obj = new Edit("edtDeptCd","122","399","120","22",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            obj.set_readonly("true");
            obj.set_cssclass("point");
            this.addChild(obj.name, obj);

            obj = new Button("btnDept","252","399","22","22",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_cssclass("btn_WF_PopSrch");
            this.addChild(obj.name, obj);

            obj = new Edit("edtDeptNm","284","399","120","22",null,null,null,null,null,null,this);
            obj.set_taborder("28");
            obj.set_enable("true");
            obj.set_readonly("false");
            obj.set_cssclass("point");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\" band=\"left\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"200\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"NO\"/><Cell col=\"1\" text=\"발령구분\"/><Cell col=\"2\" text=\"시작일\"/><Cell col=\"3\" text=\"종료일\"/><Cell col=\"4\" text=\"보직부서/보직명\"/><Cell col=\"5\" text=\"대표보직\"/></Band><Band id=\"body\"><Cell expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"1\" text=\"bind:BALRYEONG_GBCD\" displaytype=\"combotext\" combodataset=\"dsGrdBalryeong\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"2\" text=\"bind:BALRYEONG_FRDT\" calendardateformat=\"yyyy-MM-dd\" displaytype=\"date\"/><Cell col=\"3\" text=\"bind:BALRYEONG_TODT\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"4\" text=\"bind:ASMT_NAME\"/><Cell col=\"5\" text=\"bind:DAEPYO_BOJIK_GUBUN_CD\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",820,580,this,function(p){});
            obj.set_mobileorientation("landscape");
            obj.set_description("보직발령상세");
            ...
            obj = new BindItem("item6","cboBojik","value","dsMaster","BOJIK_GBCD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item9","divSearch.form.cboSearchGyeyakje","value","ds_input","GYEYAKJE_GUBUN_YN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","edtDeptCd","value","dsMaster","BOJIK_DEPT_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","edtDeptNm","value","dsMaster","BOJIK_DEPT_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("AM01_3010101_P04.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): AM01_3010101_P04.xfdl(보직발령상세)
        * 작 성         일 명: jiback
        * 작 성         일 자: 2022/08/19
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        /**********************************************************************
                02. 폼 변수 정의
        ***********************************************************************/
        this.lvchkColidDs   = "BALRYEONG_FRDT$BOJIK_GBCD$BOJIK_DEPT_CD";                        // 필수 입력사항 칼럼ID  예)  "commSmcd$commName"
        this.lvchkColNameDs = "발령시작일$보직명$보직부서";
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        {
            var strDs    = "dsGrdBalryeong|dsBojik";                    // 데이터를 받을 데이터셋리스트     예) "DS_CODE01|DS_CODE02|DS_CODE03"
            var strLgcd  = "00211|00216";                           // 공통코드 중분류 코드, 데이터셋 개수와 같아야 한다. 예) "Z01|Z02|Z03"
            var strComb  = "X|S";                                   // 콤보옵션 (T:전체, S:선택, N:공백, X:해당사항없음)
        	...
        	switch(strId)
        	{
        		case "dept" :
        				...
        				if(sRtn[0] != "CLOSE")
        				{
        		            ...
        		            this.dsMaster.setColumn(this.dsMaster.rowposition, "BOJIK_DEPT_CD", sRtn[0]);
        		            this.dsMaster.setColumn(this.dsMaster.rowposition, "BOJIK_DEPT_NM", sRtn[1]);
        ...
        ***********************************************************************/
        ...
        {
            var strSvc      = "Ret";
            var strUrl      = "/prj/AM/AM01/Retrieve_3010101_P04.do";
        ...
        ***********************************************************************/
        ...
        this.fn_New = function()
        {
        	...
        	this.dsMaster.setColumn(nRow,"BALRYEONG_GBCD","0501");
        	this.dsMaster.setColumn(nRow,"BOJIK_GBCD","");
        };
        ...
        ***********************************************************************/
        ...
        this.fn_Del = function()
        {
            ...
            var strSvc      = "Del";
            var strUrl      = "/prj/AM/AM01/Delete_3010101_P04.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Save = function()
        {
            ...
            var strSvc      = "Save";
            var strUrl      = "/prj/AM/AM01/Save_3010101_P04.do";
        ...
        ***********************************************************************/
        ...
        this.fn_setCallDeptPopup = function(strColumnName, strSearchValue)
        {
        	...
        	{
        		this.dsMaster.setColumn(this.dsMaster.rowposition, "BOJIK_DEPT_CD", this.dsDept.getColumn(0,"DEPT_CD"));
        		this.dsMaster.setColumn(this.dsMaster.rowposition, "BOJIK_DEPT_NM", this.dsDept.getColumn(0,"DEPT_NM"));
        	} else
        	{
        ...
        ***********************************************************************/
        ...
        {
        	if (e.columnid == 'DAEPYO_BOJIK_GUBUN_CD' && e.newvalue == '1' && !this.gfn_isNull(obj.getColumn(e.row, 'BALRYEONG_TODT')))
        	{
        		this.alert('이미 임기가 끝난 보직 입니다. **대표보직불가');
        		return false;
        	}
        	return true;
        };
        ...
        {
        	if (e.columnid == "BOJIK_DEPT_NM")
        	{
        	   if (this.gfn_isNull(e.newvalue)) {
        	       obj.setColumn(obj.rowposition, "BOJIK_DEPT_CD", "");
        	   } else {
        ...
        this.cboBojik_onitemchanged = function(obj,e)
        {
        	var nRow = this.dsMaster.rowposition;
        	var bojikDeptNm = this.gfn_isNull(this.dsMaster.getColumn(nRow, 'BOJIK_DEPT_NM'))?'':this.dsMaster.getColumn(nRow, 'BOJIK_DEPT_NM');
        	var bojikGbcd = this.gfn_isNull(this.cboBojik.value)?'':this.gfn_adm_trim(this.cboBojik.text);
        	this.dsMaster.setColumn(nRow, "ASMT_NAME", bojikDeptNm+"/"+bojikGbcd);
        };
        });
        ...
        this.on_initEvent = function()
        {
            ...
            this.cboBojik.addEventHandler("onitemchanged",this.cboBojik_onitemchanged,this);
        ...
        this.loadIncludeScript("AM01_3010101_P04.xfdl");
