(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("AM01_3010102_P01.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): AM01_3010102_P01.xfdl(직원번호생성)
        * 작 성         일 명: jiback
        * 작 성         일 자: 2022/08/17
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.divBg1_divSelect_cboJikgeup_onitemchanged = function(obj,e)
        {
        	var jikgeupGbcd = obj.value;
        	var findRow = this.dsJikgeup.findRow("CODE",jikgeupGbcd);
        	this.ds_input.setColumn(0, "JIKJONG_GBCD", this.dsJikgeup.getColumn(findRow,"REF_3"));

            if(jikgeupGbcd =="102010") {
        ...
        this.loadIncludeScript("AM01_3010102_P01.xfdl");
