(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("AM01_3010102_P02.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): AM01_3010102_P02.xfdl(소속발령상세)
        * 작 성         일 명: jiback
        * 작 성         일 자: 2022/08/19
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.lvchkColNameDs = "발령시작일$학교명$부서";
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.fn_New = function()
        {
        	...
        	this.dsMaster.setColumn(nRow,"BEFR_ANNC",(gyeyeolCd?this.cboBfGyeyeol.text:'')+"/"+(deptCd?this.cboBfHakgwa.text:'')+"/");
        };
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("AM01_3010102_P02.xfdl");
