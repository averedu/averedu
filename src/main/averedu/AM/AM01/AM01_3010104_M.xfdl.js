(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("기초");
            obj.set_url("AM01::AM01_3010104_T01.xfdl");
            this.Tab.addChild(obj.name, obj);

            obj = new Tabpage("TabPage2",this.Tab);
            obj.set_text("신상");
            obj.set_url("AM01::AM01_3010104_T02.xfdl");
            this.Tab.addChild(obj.name, obj);

            obj = new Tabpage("TabPage3",this.Tab);
            obj.set_text("경력");
            obj.set_url("AM01::AM01_3010104_T03.xfdl");
            this.Tab.addChild(obj.name, obj);

            obj = new Tabpage("TabPage4",this.Tab);
            obj.set_text("발령");
            obj.set_url("AM01::AM01_3010104_T04.xfdl");
            this.Tab.addChild(obj.name, obj);

            obj = new Tabpage("TabPage5",this.Tab);
            obj.set_text("보직");
            obj.set_url("AM01::AM01_3010104_T05.xfdl");
            this.Tab.addChild(obj.name, obj);

            obj = new Tabpage("TabPage6",this.Tab);
            obj.set_text("자격증");
            obj.set_url("AM01::AM01_3010104_T06.xfdl");
            this.Tab.addChild(obj.name, obj);

            obj = new Tabpage("TabPage7",this.Tab);
            obj.set_text("학력");
            obj.set_url("AM01::AM01_3010104_T07.xfdl");
            this.Tab.addChild(obj.name, obj);

            obj = new Tabpage("TabPage8",this.Tab);
            obj.set_text("가족");
            obj.set_url("AM01::AM01_3010104_T08.xfdl");
            this.Tab.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","AM01::AM01_3010104_T01.xfdl");
            this._addPreloadList("fdl","AM01::AM01_3010104_T02.xfdl");
            this._addPreloadList("fdl","AM01::AM01_3010104_T03.xfdl");
            this._addPreloadList("fdl","AM01::AM01_3010104_T04.xfdl");
            this._addPreloadList("fdl","AM01::AM01_3010104_T05.xfdl");
            this._addPreloadList("fdl","AM01::AM01_3010104_T06.xfdl");
            this._addPreloadList("fdl","AM01::AM01_3010104_T07.xfdl");
            this._addPreloadList("fdl","AM01::AM01_3010104_T08.xfdl");
            this._addPreloadList("data","","dsMaster");
        };
        
        // User Script
        this.registerScript("AM01_3010104_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): AM01_3010104_M.xfdl(강사 정보관리)
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/09/26
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        this.fn_formInit = function() {
        	...
        	// 직종구분 - 3010.시간강사
        	this.dsSearchJikjong.set_filterstr("CODE == '3010'");
        };
        ...
        ***********************************************************************/
        ...
        this.fn_New = function()
        {
        	...
        	this.gfn_openPopup("popup","AM01::AM01_3010104_P01.xfdl",oArg,sPopupCallBack,oOption);
        };
        ...
        ***********************************************************************/
        ...
        this.divSearch1_btnGangui_onclick = function(obj,e)
        {
        	if (this.dsMaster.rowposition > -1) {
        		...
        		var oOption = {};
        		var sPopupCallBack = "fn_popupCallback";
        		this.gfn_openPopup("popup","AM01::AM01_3010104_P06.xfdl",oArg,sPopupCallBack,oOption);
        	} else {
        ...
        this.loadIncludeScript("AM01_3010104_M.xfdl");
