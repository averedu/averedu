(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"32\"/><Column id=\"CODE_NM\" type=\"STRING\" size=\"32\"/><Column id=\"REF_3\" type=\"STRING\" size=\"256\"/><Column id=\"REF_4\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Dataset("dsJikjong2", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"32\"/><Column id=\"CODE_NM\" type=\"STRING\" size=\"32\"/><Column id=\"REF_2\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtSearchSosok","319","36","170","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("18");
            obj.set_autoselect("true");
            obj.set_password("false");
            obj.set_readonly("true");
            ...
            obj = new Combo("cboBfJikjong","122","426","286","22",null,null,null,null,null,null,this);
            obj.set_taborder("30");
            ...
            obj = new Combo("cboBfJikgeup","122","453","286","22",null,null,null,null,null,null,this);
            obj.set_taborder("31");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("CODE_NM");
            obj.set_readonly("true");
            ...
            obj = new Combo("cboAfJikjong","522","426","286","22",null,null,null,null,null,null,this);
            obj.set_taborder("32");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("CODE_NM");
            obj.set_readonly("true");
            obj.set_cssclass("point");
            obj.set_innerdataset("dsJikjong2");
            obj.set_text("");
            obj.set_value("1");
            obj.set_index("0");
            this.addChild(obj.name, obj);

            obj = new Combo("cboAfJikgeup","522","453","286","22",null,null,null,null,null,null,this);
            obj.set_taborder("33");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("CODE_NM");
            obj.set_readonly("true");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\" band=\"left\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"170\"/><Column size=\"170\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"NO\"/><Cell col=\"1\" text=\"발령구분\"/><Cell col=\"2\" text=\"시작일\"/><Cell col=\"3\" text=\"종료일\"/><Cell col=\"4\" text=\"발령 &quot;전&quot;\"/><Cell col=\"5\" text=\"발령 &quot;후&quot;\"/></Band><Band id=\"body\"><Cell expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"1\" text=\"bind:BALRYEONG_GBCD\" combodataset=\"dsGrdBalryeong\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\" displaytype=\"combotext\"/><Cell col=\"2\" text=\"bind:BALRYEONG_FRDT\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"3\" text=\"bind:BALRYEONG_TODT\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"4\" text=\"bind:BEFR_CLSS\"/><Cell col=\"5\" text=\"bind:AFTR_CLSS\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",820,580,this,function(p){});
            obj.set_mobileorientation("landscape");
            obj.set_description("직급발령상세");
            ...
            obj = new BindItem("item4","cboBfJikjong","value","dsMaster","JIKJONG_GBCD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","cboBfJikgeup","value","dsMaster","JIKGEUP_GBCD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","cboAfJikjong","value","dsMaster","JIKJONGHU_GBCD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item8","cboAfJikgeup","value","dsMaster","JIKGEUPHU_GBCD");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item6","cboBalryeongGbcd","value","dsMaster","BALRYEONG_GBCD");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("AM01_3010104_P03.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): AM01_3010104_P03.xfdl(직급발령상세)
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/09/26
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        /**********************************************************************
                02. 폼 변수 정의
        ***********************************************************************/
        this.lvchkColidDs   = "BALRYEONG_GBCD$BALRYEONG_FRDT$JIKJONGHU_GBCD$JIKGEUPHU_GBCD";                        // 필수 입력사항 칼럼ID  예)  "commSmcd$commName"
        this.lvchkColNameDs = "발령구분$발령시작일$발령 후 직종$발령 후 직급";
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        {
            var strDs    = "dsGrdBalryeong|dsBalryeong|dsJikjong|dsJikjong2|dsJikgeup";                    // 데이터를 받을 데이터셋리스트     예) "DS_CODE01|DS_CODE02|DS_CODE03"
            var strLgcd  = "00211|00211|00205|00205|00201";                           // 공통코드 중분류 코드, 데이터셋 개수와 같아야 한다. 예) "Z01|Z02|Z03"
            var strComb  = "X|S|S|S|S";                                   // 콤보옵션 (T:전체, S:선택, N:공백, X:해당사항없음)
        ...
        this.fn_PostformInit = function()
        {
        	...
        	var jikwonGbcd = this.ds_input.getColumn(0, "JIKWON_GBCD");

        	// 직원구분에 따른 인사발령 filter
        	if (jikwonGbcd == "10" || jikwonGbcd == "30") {
        	    this.dsBalryeong.set_filterstr("REF_3=='30' || CODE==null");
        	} else if (jikwonGbcd == "20" || jikwonGbcd == "40") {
        	    this.dsBalryeong.set_filterstr("REF_4=='20' || CODE==null");
        	}
        ...
        ***********************************************************************/
        ...
        {
            var strSvc      = "Ret";
            var strUrl      = "/prj/AM/AM01/Retrieve_3010101_P03.do";
        ...
        ***********************************************************************/
        ...
        this.fn_New = function()
        {
        	...
        	this.cboAfJikjong.set_readonly(false);   	//후 직종
        	this.cboAfJikgeup.set_readonly(false);   	//후 직급
        	this.cboBalryeongGbcd.set_readonly(false);   //발령구분
        	this.calBalryeongFrDt.set_readonly(false);   //발령 시작일
        	this.calBalryeongToDt.set_readonly(false);   //발령 종료일

        	var lastRow = this.dsMaster.rowcount - 1;
        	var sabeon = this.dsMaster.getColumn(lastRow,"SABEON");             	//사번
        	var deptCd = this.dsMaster.getColumn(lastRow,"BOJIK_BUSEO_CD");     	//부서
        	var jeongongCd = this.dsMaster.getColumn(lastRow,"JEONGONG_CD");    	//전공
        	var textJikjongJikgeup = this.dsMaster.getColumn(lastRow,"AFTR_CLSS")  	//직종/직급
        	var jikjongGbcd = this.dsMaster.getColumn(lastRow,"JIKJONGHU_GBCD");   	//발령전 직종
        	var jikgeupGbcd = this.dsMaster.getColumn(lastRow,"JIKGEUPHU_GBCD");   	//전공
        	...
        	this.dsMaster.setColumn(nRow, "BEFR_CLSS", textJikjongJikgeup);
        	this.dsMaster.setColumn(nRow, "JIKJONG_GBCD", jikjongGbcd);
        	this.dsMaster.setColumn(nRow, "JIKGEUP_GBCD", jikgeupGbcd);
        	this.dsMaster.setColumn(nRow, "JIKJONGHU_GBCD", '');
        	this.dsMaster.setColumn(nRow, "JIKGEUPHU_GBCD", '');
        };
        ...
        ***********************************************************************/
        ...
        this.fn_Del = function()
        {
            ...
            var strSvc      = "Del";
            var strUrl      = "/prj/AM/AM01/Delete_3010101_P03.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Save = function()
        {
            ...
            var strSvc      = "Save";
            var strUrl      = "/prj/AM/AM01/Save_3010101_P03.do";
        ...
        ***********************************************************************/
        ...
        this.dsMaster_onrowposchanged = function(obj,e)
        {
        	...
        	{
        		this.cboAfJikjong.set_readonly(false);
        		this.cboAfJikgeup.set_readonly(false);
        	}
        	else
        	{
        		this.cboAfJikjong.set_readonly(true);
        		this.cboAfJikgeup.set_readonly(true);
        	}
        };

        this.cboAfJikjong_ondropdown = function(obj,e)
        {
        	var jikwonGbcd = this.ds_input.getColumn(0, "JIKWON_GBCD");
        	// 직원구분에 따른 직종 filter
        	if (jikwonGbcd == "10" || jikwonGbcd == "30") {
        	    this.dsJikjong2.set_filterstr("REF_2=='10' || REF_2=='30' || CODE==null");
        	} else if (jikwonGbcd == "20") {
        	    this.dsJikjong2.set_filterstr("REF_2=='20' || CODE==null");
        	} else if (jikwonGbcd == "40") {
        	    this.dsJikjong2.set_filterstr("REF_2=='40' || CODE==null");
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.cboAfJikjong.addEventHandler("ondropdown",this.cboAfJikjong_ondropdown,this);
            this.grdMaster.addEventHandler("onselectchanged",this.Grid00_onselectchanged,this);
            this.dsMaster.addEventHandler("onrowposchanged",this.dsMaster_onrowposchanged,this);
        };
        this.loadIncludeScript("AM01_3010104_P03.xfdl");
