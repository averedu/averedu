(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_text("기초");
            obj.set_url("AM01::AM01_3010105_T01.xfdl");
        ...
        {
            this._addPreloadList("fdl","AM01::AM01_3010105_T01.xfdl");
        ...
        // User Script
        this.registerScript("AM01_3010105_M.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        this.fn_formInit = function()
        {
            ...
            var strComb  = "T|X|X|T|X|T|X|X|X";                                   // 콤보옵션 (T:전체, S:선택, N:공백, X:해당사항없음)
        	...
        	// 직원구분 - 40.조교
        	this.dsSearchJikwon.set_filterstr("CODE == '40'");
        	// 직종구분 - 4010.조교
        	this.dsSearchJikjong.set_filterstr("CODE == '4010' || CODE_NM == '전체'");
        	this.dsSearchJikjeup.set_filterstr("CODE_NM == '전체'");
        };

        this.fn_PostformInit = function()
        {
        	this.divSearch.form.cboSearchJikwon.set_index(0);
        ...
        ***********************************************************************/
        ...
        {
        	if (obj.value == "4010") {
        		this.dsSearchJikjeup.set_filterstr("");
        		this.dsSearchJikjeup.set_filterstr("REF_3 == '4010' || CODE_NM == '전체'");
        	} else {
        		this.dsSearchJikjeup.set_filterstr("");
        		this.dsSearchJikjeup.set_filterstr("CODE_NM == '전체'");
        	}
        ...
        this.loadIncludeScript("AM01_3010105_M.xfdl");
