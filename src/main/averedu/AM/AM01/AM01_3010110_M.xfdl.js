(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"1\"/><Column id=\"WIWONHOE_CD\" type=\"STRING\" size=\"10\"/><Column id=\"WIWONHOE_NM\" type=\"STRING\" size=\"100\"/><Column id=\"SORT\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"1\"/><Column id=\"BIGO\" type=\"STRING\" size=\"1000\"/><Column id=\"YONGDO_COLUMN1\" type=\"STRING\" size=\"100\"/><Column id=\"YONGDO_COLUMN2\" type=\"STRING\" size=\"100\"/><Column id=\"YONGDO_COLUMN3\" type=\"STRING\" size=\"100\"/><Column id=\"YONGDO_COLUMN4\" type=\"STRING\" size=\"100\"/><Column id=\"YONGDO_COLUMN5\" type=\"STRING\" size=\"100\"/></ColumnInfo>");
            ...
            obj = new Static("stc_19_00_00_01_00_00","0",null,"1640","28",null,"138",null,null,null,null,this);
            obj.set_taborder("18");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\" band=\"left\"/><Column size=\"48\" band=\"left\"/><Column size=\"100\" band=\"left\"/><Column size=\"240\" band=\"left\"/><Column size=\"50\"/><Column size=\"60\"/><Column size=\"240\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"NO\"/><Cell col=\"2\" text=\"위원회 코드\"/><Cell col=\"3\" text=\"위원회명\"/><Cell col=\"4\" text=\"순서\" suppressalign=\"first\"/><Cell col=\"5\" text=\"사용여부\"/><Cell col=\"6\" text=\"비고\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\" textAlign=\"center\" edittype=\"none\"/><Cell col=\"2\" text=\"bind:WIWONHOE_CD\"/><Cell col=\"3\" text=\"bind:WIWONHOE_NM\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:SORT\"/><Cell col=\"5\" text=\"bind:USE_YN\" combodataset=\"USE_YN\" combodatacol=\"LABEL\" combocodecol=\"CD\" displaytype=\"combotext\"/><Cell col=\"6\" text=\"bind:BIGO\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("stc_09","0","10","125","22",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("위원회 정보관리");
            ...
            obj = new Static("stRowCnt","125","9","233","24",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Static("stc_19_00_00_01_00","0",null,"1640","28",null,"111",null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_cssclass("sta_WF_DetailBg");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("stc_20_00_00_01_00","0",null,"150","28",null,"111",null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("순서");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);

            obj = new Static("stc_21_00_00_00_02_00","500",null,"150","28",null,"111",null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);

            obj = new Static("stc_21_00_00_00_02_00_00","500",null,"150","28",null,"138",null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("위원회명");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);

            obj = new Static("stc_20_00_00_01_00_00","0",null,"150","28",null,"138",null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("위원회코드");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);

            obj = new Combo("cboUseYn","653",null,"150","22",null,"114",null,null,null,null,this);
            obj.set_taborder("21");
            ...
            obj = new Edit("edtSort","153",null,"300","22",null,"114",null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_maxlength("166");
            this.addChild(obj.name, obj);

            obj = new Edit("edtWiwonhoeCd","153",null,"300","22",null,"141",null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_maxlength("166");
            this.addChild(obj.name, obj);

            obj = new Edit("edtWiwonheoNm","653",null,"300","22",null,"141",null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_maxlength("166");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","cboUseYn","value","dsMaster","USE_YN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","edtSort","value","dsMaster","SORT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","edtWiwonhoeCd","value","dsMaster","WIWONHOE_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","edtWiwonheoNm","value","dsMaster","WIWONHOE_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("AM01_3010110_M.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("AM01_3010110_M.xfdl");
