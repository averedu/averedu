(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_updatecontrol("true");
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"10\"/><Column id=\"SABEON\" type=\"STRING\" size=\"10\"/><Column id=\"SEQ\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"SANGBEOL_GBCD\" type=\"STRING\" size=\"6\"/><Column id=\"SIHAENG_GIGWAN\" type=\"STRING\" size=\"80\"/><Column id=\"SANGBEOL_NAEYONG\" type=\"STRING\" size=\"80\"/><Column id=\"BIGO\" type=\"STRING\" size=\"50\"/><Column id=\"FRDT\" type=\"STRING\" size=\"8\"/><Column id=\"TODT\" type=\"STRING\" size=\"8\"/><Column id=\"SANGBEOL_JEOMSU\" type=\"STRING\" size=\"8\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"260\"/><Column size=\"40\"/><Column size=\"150\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"NO\"/><Cell col=\"1\" rowspan=\"2\" text=\"상벌구분\" combodataset=\"DS_COMMON_CD_228\" combocodecol=\"CD\" combodatacol=\"CDNM\"/><Cell col=\"2\" colspan=\"2\" text=\"상벌일자\"/><Cell col=\"4\" rowspan=\"2\" text=\"상벌내용\"/><Cell col=\"5\" rowspan=\"2\" text=\"점수\"/><Cell col=\"6\" rowspan=\"2\" text=\"시행기관\"/><Cell col=\"7\" rowspan=\"2\" text=\"비고\"/><Cell row=\"1\" col=\"2\" text=\"시작일\"/><Cell row=\"1\" col=\"3\" text=\"종료일\"/></Band><Band id=\"body\"><Cell expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\" textAlign=\"center\" edittype=\"none\"/><Cell col=\"1\" text=\"bind:SANGBEOL_GBCD\" edittype=\"combo\" displaytype=\"combotext\" combodataset=\"dsGrdSangbeol\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"2\" text=\"bind:FRDT\" edittype=\"date\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"3\" text=\"bind:TODT\" edittype=\"date\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"4\" text=\"bind:SANGBEOL_NAEYONG\" edittype=\"text\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:SANGBEOL_JEOMSU\" edittype=\"text\" editinputtype=\"number\" editmaxlength=\"3\"/><Cell col=\"6\" edittype=\"text\" text=\"bind:SIHAENG_GIGWAN\" textAlign=\"left\"/><Cell col=\"7\" edittype=\"text\" text=\"bind:BIGO\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("AM02_3010201_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): AM02_3010201_M.xfdl(상벌관리)
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/09/27
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        /**********************************************************************
                02. 폼 변수 정의
        ***********************************************************************/
        this.lvchkColidDs   = "SANGBEOL_GBCD$FRDT"; // 필수 입력사항 칼럼ID  예) "commSmcd$commName"
        this.lvchkColNameDs = "상벌구분$시작일자";
        ...
        ***********************************************************************/
        ...
        {
            var strDs    = "dsSearchJikwon|dsSearchJaejik|dsSearchJikjong|dsSearchJikjeup|dsGrdSangbeol";	// 데이터를 받을 데이터셋리스트 예) "DS_CODE01|DS_CODE02|DS_CODE03"
            var strLgcd  = "00207|00208|00205|00201|00228"; 												// 공통코드 중분류 코드, 데이터셋 개수와 같아야 한다. 예) "Z01|Z02|Z03"
            var strComb  = "X|T|T|T|S"; 																	// 콤보옵션 (T:전체, S:선택, N:공백, X:해당사항없음)
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function()
        {
            ...
            var strSvc      = "Ret";
            var strUrl      = "/prj/AM/AM02/Retrieve_3010201_MList.do";
        ...
        this.fn_RetDetail = function()
        {
            ...
            var strUrl      = "/prj/AM/AM02/Retrieve_3010201_DList.do";
        ...
        ***********************************************************************/
        ...
        this.fn_New = function()
        {
        	...
        	this.dsDetail.setColumn(nRow, "SANGBEOL_GBCD", 	"");
        };
        ...
        ***********************************************************************/
        ...
        this.fn_Del = function()
        {
            ...
            var strSvc      = "Del";
            var strUrl      = "/prj/AM/AM02/Delete_3010201_MList.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Save = function()
        {
            ...
            var strSvc      = "Save";
            var strUrl      = "/prj/AM/AM02/Save_3010201_MList.do";
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("AM02_3010201_M.xfdl");
