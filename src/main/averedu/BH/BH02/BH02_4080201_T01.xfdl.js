(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("stc_09_00_00_00","745","311","100","31",null,null,null,null,null,null,this);
            obj.set_taborder("43");
            obj.set_text("상벌점 이력");
            obj.set_cssclass("sta_WF_Title02");
            this.addChild(obj.name, obj);

            obj = new Static("staRowCntDetail","845","314","200","24",null,null,null,null,null,null,this);
            obj.set_taborder("44");
            obj.set_text("[총 <fc v=\'red\'><b v=\'true\'>0 </b></fc>건]");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);

            obj = new Grid("grdMaster00","745","343",null,null,"10","8",null,null,null,null,this);
            obj.set_taborder("45");
            obj.set_binddataset("dsDetail");
            obj.set_autofittype("col");
            obj.set_fillareatype("none");
            obj.set_autosizingtype("row");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"50\"/><Column size=\"180\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"상벌일자\"/><Cell col=\"1\" text=\"상벌코드\"/><Cell col=\"2\" text=\"점수\"/><Cell col=\"3\" text=\"상벌내용\"/></Band><Band id=\"body\"><Cell text=\"bind:RWPN_DATE\" calendardateformat=\"yyyy-MM-dd\" displaytype=\"date\"/><Cell col=\"1\" text=\"bind:RWPN_CODE\"/><Cell col=\"2\" text=\"bind:RWPN_SCOR\"/><Cell col=\"3\" text=\"bind:RMRK_NOTE\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("BH02_4080201_T01.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): BH02_4080201_T01.xfdl(재학생)
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/10/06
        * 변 경         일 자:
        * 변 경         자 명:
        	...
        	switch(strId) {
        		case "hakbeon" :
        				...
        				if (sRtn[0] != "CLOSE") {
        		            ...
        		            this.dsMaster.setColumn(nRow, "HAKNYEON", sRtn[4]); // 학년
        		            this.dsMaster.setColumn(nRow, "ROOM_GUBN", "");
        		            this.dsMaster.setColumn(nRow, "STNT_GUBN", "0");
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function(obj)
        {
            ...
            var strSvc      = "Ret";
            var strUrl      = "/prj/BH/BH02/Retrieve_4080201_T01List.do";
        ...
        this.fn_RetDetail = function() {
            ...
            var strUrl      = "/prj/BH/BH02/Retrieve_4080201_T01ListDetail.do";
        ...
        ***********************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdMaster00.addEventHandler("onheaddblclick",this.grdMaster_onheaddblclick,this);
        ...
        this.loadIncludeScript("BH02_4080201_T01.xfdl");
