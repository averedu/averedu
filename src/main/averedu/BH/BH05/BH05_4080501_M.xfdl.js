(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"1\"/><Column id=\"SCHL_YEAR\" type=\"STRING\" size=\"4\"/><Column id=\"SCHL_SMST\" type=\"STRING\" size=\"2\"/><Column id=\"ROOM_GUBN\" type=\"STRING\" size=\"2\"/><Column id=\"AMNT_0001\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"AMNT_0002\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"AMNT_0003\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"AMNT_0004\" type=\"BIGDECIMAL\" size=\"22\"/></ColumnInfo>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"HAKSA_YEAR\" type=\"STRING\" size=\"256\"/><Column id=\"HAKSA_HAKGI\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stc_09_00","0","46","145","31",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("생활관비 등록 목록");
            obj.set_cssclass("sta_WF_Title02");
            this.addChild(obj.name, obj);

            obj = new Static("staRowCnt","145","51","200","24",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Grid("grdMaster","0","79",null,"500","0",null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"35\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\"/><Cell col=\"1\" text=\"No\"/><Cell col=\"2\" text=\"등록년도\"/><Cell col=\"3\" text=\"학기\"/><Cell col=\"4\" text=\"인실구분\"/><Cell col=\"5\" text=\"관리비\"/><Cell col=\"6\" text=\"식비\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\" editmaxlength=\"1\"/><Cell col=\"1\" expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"2\" text=\"bind:SCHL_YEAR\"/><Cell col=\"3\" text=\"bind:SCHL_SMST\" displaytype=\"combotext\" combodataset=\"dsHakgi\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"4\" text=\"bind:ROOM_GUBN\" displaytype=\"combotext\" combodataset=\"dsInsil\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"5\" text=\"bind:AMNT_0001\" displaytype=\"number\"/><Cell col=\"6\" text=\"bind:AMNT_0002\" displaytype=\"number\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00_00","200","579","100","35",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("↑\r\n35\r\n↓");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("stc_09_00_00","0","583","85","31",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("기초정보");
            obj.set_cssclass("sta_WF_Title02");
            this.addChild(obj.name, obj);

            obj = new Static("Static01_00_00_00","580","579","30",null,null,"0",null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("30");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_01_00_00_00_00","0","608",null,"8","0",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("8");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("stc_13_06_01_00_01_00","0","616","580","28",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_DetailBg");
            this.addChild(obj.name, obj);

            obj = new Static("stc_09_00_00_00","610","583","85","31",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("생활관비");
            obj.set_cssclass("sta_WF_Title02");
            this.addChild(obj.name, obj);

            obj = new Static("stc_12_06_02_00_01_00_03","0","616","130","28",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("등록년도");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);

            obj = new Static("stc_12_06_02_00_01_00_01_02","290","616","130","28",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("등록학기");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);

            obj = new Static("stc_13_06_01_00_01_00_00","0","643","580","28",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_DetailBg");
            this.addChild(obj.name, obj);

            obj = new Static("stc_12_06_02_00_01_00_01_02_00","290","643","130","28",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("인실구분");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);

            obj = new Combo("cboInsil","423","646","154","22",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("CODE_NM");
            ...
            obj = new Combo("cboCertGubn00_00","423","619","154","22",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_innerdataset("dsHakgi");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("CODE_NM");
            ...
            obj = new Static("stc_13_06_01_00_01_00_01","610","616","580","28",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_cssclass("sta_WF_DetailBg");
            this.addChild(obj.name, obj);

            obj = new Static("stc_12_06_02_00_01_00_01_02_01","610","616","130","28",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("관리비");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);

            obj = new Static("stc_12_06_02_00_01_00_01_02_01_00","900","616","130","28",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("식비");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);

            obj = new Edit("edtAmnt0001","743","619","154","22",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Edit("edtAmnt0002","1033","619","154","22",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_enable("true");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Spin("spnSearchYYYY","133","619","154","22",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);
            // Layout Functions
            ...
            obj.set_description("생활관 등록");
            obj.set_mobileorientation("landscape");
            this.addLayout(obj.name, obj);
            
            // BindItem Information
            obj = new BindItem("item0","divSearch00.form.spnSearchYYYY","value","ds_input","HAKSA_YEAR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch00.form.cboSearchHakgi","value","ds_input","HAKSA_HAKGI");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","spnSearchYYYY","value","dsMaster","SCHL_YEAR");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","cboCertGubn00_00","value","dsMaster","SCHL_SMST");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","cboInsil","value","dsMaster","ROOM_GUBN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","edtAmnt0001","value","dsMaster","AMNT_0001");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item6","edtAmnt0002","value","dsMaster","AMNT_0002");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("BH05_4080501_M.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.divSearch00_spnSearchYYYY_canchange = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch00.form.spnSearchYYYY.addEventHandler("canchange",this.divSearch00_spnSearchYYYY_canchange,this);
            ...
            this.spnSearchYYYY.addEventHandler("onkeydown",this.fn_onKeyDown,this);
        ...
        this.loadIncludeScript("BH05_4080501_M.xfdl");
