(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"IPSI_YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_dInput", this);
            obj._setContents("<ColumnInfo><Column id=\"IPSI_YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"SABEON\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj.set_updatecontrol("true");
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"IPSI_YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"SABEON\" type=\"STRING\" size=\"256\"/><Column id=\"GOGYO_CD\" type=\"STRING\" size=\"256\"/><Column id=\"GOGYO_NM\" type=\"STRING\" size=\"256\"/><Column id=\"JIYEOK_GBCD\" type=\"STRING\" size=\"256\"/><Column id=\"SEBUJIYEOK_GBCD\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdMaster","10","132",null,null,"835","9",null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"55\"/><Column size=\"122\"/><Column size=\"113\"/><Column size=\"234\"/><Column size=\"0\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"교수코드\"/><Cell col=\"2\" text=\"교수명\"/><Cell col=\"3\" text=\"학부학과\"/><Cell col=\"4\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" editmaxlength=\"256\" expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"1\" displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" text=\"bind:SABEON\" editmaxlength=\"256\"/><Cell col=\"2\" text=\"bind:SEONGMYEONG\" displaytype=\"normal\" edittype=\"none\"/><Cell col=\"3\" text=\"bind:DEPT_CD\" displaytype=\"normal\" combodataset=\"dsHakgwa\" combocodecol=\"DEPT_CD\" combodatacol=\"DEPT_NM\" edittype=\"none\"/><Cell col=\"4\" text=\"bind:IPSI_YYYY\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_01_00_00_00_01","805","160","30","100",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("30");
            ...
            obj = new Static("Static01_01_00_00_00","20","124","1610","8",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("8");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Spin("spnSearchYYYY","88","9","119","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            ...
            obj = new Combo("cboSearchHakgwa","330","9","170","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Static("Static01_02_01_01","207","0","56","40",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("← 56 →");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02_00_00","320","0","10","40",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Grid("grdDetail",null,"132","795",null,"10","9",null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_autofittype("col");
            obj.set_autoenter("select");
            obj.set_cellsizingtype("col");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"200\"/><Column size=\"269\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"고교코드\"/><Cell col=\"2\" text=\"고교명\"/><Cell col=\"3\" text=\"지역\"/><Cell col=\"4\" text=\"세부지역\"/></Band><Band id=\"body\"><Cell displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" editmaxlength=\"256\" combodataset=\"dsJeonHyung\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\" expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"1\" displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" text=\"bind:GOGYO_CD\" editmaxlength=\"256\"/><Cell col=\"2\" text=\"bind:GOGYO_NM\" displaytype=\"normal\" edittype=\"none\" combodataset=\"dsSebuJeonHyung\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"3\" text=\"bind:JIYEOK_GBCD\" displaytype=\"normal\" edittype=\"none\" combodataset=\"ds_Jiyeok\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"4\" text=\"bind:SEBUJIYEOK_GBCD\" displaytype=\"normal\" combodataset=\"ds_SebuJiyeok\" combodatacol=\"CODE_NM\" combocodecol=\"CODE\" edittype=\"none\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("stc_09_00_00",null,"107","85","22","720",null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("관심고교");
            obj.set_cssclass("sta_WF_Title02");
            this.addChild(obj.name, obj);

            obj = new Static("staRowCnt2",null,"106","53","24","670",null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("[총 <fc v=\'red\'><b v=\'true\'>0 </b></fc>건]");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_01_00_00_00_01_00","11","37","1600","8",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("8");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new BindItem("item9","divSearch.form.cboSearchHakgwa","value","ds_input","DEPT_CD");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("EN01_1010106_T04.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("EN01_1010106_T04.xfdl");
