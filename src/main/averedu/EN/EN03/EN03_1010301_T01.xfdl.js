(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("stc_02","224","9","80","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("모집 구분");
            ...
            obj = new Combo("cboSearchMojip","306","9","170","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Static("Static01_02_00_00_00_00","297","-1","10","40",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02","476","0","56","40",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("← 56 →");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Button("btn01",null,"8","131","25","116",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btn02",null,"8","91","25","16",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("파일생성");
            obj.set_cssclass("btn_WF_Crud");
            obj.set_tabstop("true");
            ...
            obj = new Static("stc_09_00","10","10",null,"22","1475",null,null,null,null,null,this);
            obj.set_taborder("3");
        ...
        // User Script
        this.registerScript("EN03_1010301_T01.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): EN03_1010301_T01.xfdl(지원자파일생성 관리)
        * 작 성         일 명: 성연우
        * 작 성         일 자: 2021/04/21
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        this.divSearch_btn01_onclick = function(obj,e)
        {
            ...
            var strUrl      = "/prj/EN/EN03/Retrieve_1010301_T01_MiIpryeok.do";
        ...
        ***********************************************************************/
        this.divSearch_btn02_onclick = function(obj,e)
        {
        	...
        	// 파일다운로드 보류
        	var strSvc      = "Jiwonja";
            var strUrl      = "/prj/EN/EN03/Retrieve_1010301_T01.do";
            var strInDs     = "ds_input=ds_input";
            var strOutDs    = "dsMaster=dsMaster ";
        	    strOutDs   += "dsFile=dsFile";
            var strArg      = "";
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("EN03_1010301_T01.xfdl");
