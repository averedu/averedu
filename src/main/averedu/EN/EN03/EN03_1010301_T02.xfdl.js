(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("1");
            obj.set_text("DB3 파일을 업로드하여 학생부성적 정보를 학교DB로 이관 합니다. 다소 시간이 소요될 수 있습니다");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.DivBg.addChild(obj.name, obj);
            ...
            obj.set_taborder("0");
            obj.set_text("학생정보 이관 건 수");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.DivBg.form.DivResult.addChild(obj.name, obj);

            obj = new Edit("edtCnt1","147","13","76","22",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("1");
            obj.set_readonly("true");
            this.DivBg.form.DivResult.addChild(obj.name, obj);

            obj = new Static("stc_01_00","259","13","180","22",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("2");
            obj.set_text("학생부성적 이관 건 수");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.DivBg.form.DivResult.addChild(obj.name, obj);

            obj = new Edit("edtCnt2","410","13","76","22",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("3");
            obj.set_readonly("true");
            this.DivBg.form.DivResult.addChild(obj.name, obj);

            obj = new Static("stc_01_00_00_00","522","13","180","22",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("4");
            obj.set_text("개인정보 이관 건 수");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.DivBg.form.DivResult.addChild(obj.name, obj);

            obj = new Edit("edtCnt3","660","13","76","22",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("5");
            obj.set_readonly("true");
            this.DivBg.form.DivResult.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_02_00_01","731","0","27","50",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("7");
            obj.set_text("27");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02_01","223","0","56","50",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("8");
            obj.set_text("← 56 →");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02_00_00_00_00","400","0","10","50",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("10");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02_01_00","486","0","56","50",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("11");
            obj.set_text("← 56 →");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02_00_00_00_00_00","650","0","10","50",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("12");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
        ...
        // User Script
        this.registerScript("EN03_1010301_T02.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): EN03_1010301_T02.xfdl(학생부파일이관)
        * 작 성         일 명: 성연우
        * 작 성         일 자: 2021/04/21
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.DivBg.form.divSearch.form.spnSearchYYYY.addEventHandler("onkeydown",this.DivBg_divSearch_spnSearchYYYY_onkeydown,this);
            this.DivBg.form.divSearch.form.btnUpload.addEventHandler("onclick",this.DivBg_divSearch_btnUpload_onclick,this);
        };
        this.loadIncludeScript("EN03_1010301_T02.xfdl");
