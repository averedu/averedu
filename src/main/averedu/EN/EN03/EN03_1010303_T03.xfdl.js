(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnIgwan","662","9","69","22",null,null,null,null,null,null,this.DivBg.form.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("성적이관");
            ...
            obj = new Edit("edtCnt","150","13","206","22",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("1");
            ...
            obj = new Static("Static01_02_00_00_00_00","140","0","10","50",null,null,null,null,null,null,this.DivBg.form.DivResult.form);
            obj.set_taborder("3");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
        ...
        // User Script
        this.registerScript("EN03_1010303_T03.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): EN03_1010303_T03.xfdl(검정고시성적이관)
        * 작 성         일 명: 성연우
        * 작 성         일 자: 2021/04/21
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        this.DivBg_divSearch_btnIgwan_onclick = function(obj,e)
        {
        	...
        	{
        		var strSvc      = "Igwan";
        		var strUrl      = "/prj/EN/EN03/Igwan_1010303_T03.do";
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("EN03_1010303_T03.xfdl");
