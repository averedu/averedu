(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"ROWINDEX\" type=\"STRING\" size=\"256\"/><Column id=\"STATUS\" type=\"STRING\" size=\"256\"/><Column id=\"RESULT\" type=\"STRING\" size=\"256\"/><Column id=\"ERROR\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnJeomsu","162","11","179","25",null,null,null,null,null,null,this.DivBg.form.DivButton.form);
            obj.set_taborder("0");
            obj.set_text("1. 면접(실기) 점수부여");
            obj.set_cssclass("btn_WF_Crud");
            this.DivBg.form.DivButton.addChild(obj.name, obj);

            obj = new Button("btnSeongjeok","392","11","179","25",null,null,null,null,null,null,this.DivBg.form.DivButton.form);
            obj.set_taborder("1");
            obj.set_text("2. 성적산출");
            obj.set_cssclass("btn_WF_Crud");
            this.DivBg.form.DivButton.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("EN05_1010501_M.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
         ...
         * 기능 : 저장 전 실행
         */
        this.DivBg_DivButton_btnJeomsu_onclick = function(obj,e)
        {
        ...
        ***********************************************************************/
         ...
         * 기능 : 저장 전 실행
         */
        this.DivBg_DivButton_btnSeongjeok_onclick = function(obj,e)
        {
        ...
        ***********************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.DivBg.form.DivButton.form.btnJeomsu.addEventHandler("onclick",this.DivBg_DivButton_btnJeomsu_onclick,this);
            this.DivBg.form.DivButton.form.btnSeongjeok.addEventHandler("onclick",this.DivBg_DivButton_btnSeongjeok_onclick,this);
        };
        this.loadIncludeScript("EN05_1010501_M.xfdl");
