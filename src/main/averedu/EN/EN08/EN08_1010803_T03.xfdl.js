(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("EN08_1010803_T03.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): EN04_1010803_T03.xfdl(합격자통지서)
        * 작 성         일 명: 백재인
        * 작 성         일 자: 2021/06/24
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function(data1)
        {
            ...
            var strSvc      = "Ret";
            var strUrl      = "/prj/EN/EN08/Retrieve_1010803_T03.do";
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("EN08_1010803_T03.xfdl");
