(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"IN_CREATE_GBCD\" type=\"STRING\" size=\"256\"/><Column id=\"IN_IPSI_YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"IN_DEUNGROK_YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"IN_IPHAK_DT\" type=\"STRING\" size=\"256\"/><Column id=\"IN_SUHEOM_NO\" type=\"STRING\" size=\"256\"/><Column id=\"IN_HAKBEON\" type=\"STRING\" size=\"256\"/><Column id=\"OUT_RESULT\" type=\"STRING\" size=\"256\"/><Column id=\"OUT_RESULT_CONT\" type=\"STRING\" size=\"256\"/><Column id=\"OUT_TOTAL_CNT\" type=\"BIGDECIMAL\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Calendar("calSearchIphakDt","325","9","131","22",null,null,null,null,null,null,this.DivBg.form.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Div("DivDelHakjeok","10","380",null,"80","10",null,null,null,null,null,this.DivBg.form.DivContent.form);
            obj.set_taborder("3");
            obj.set_background("#e3ebff");
            obj.set_border("1px solid #4c4b66");
            obj.set_text("");
            ...
            obj = new Static("stc_01_01_00_00","-1","29","70","22",null,null,null,null,null,null,this.DivBg.form.DivContent.form.DivDelHakjeok.form);
            obj.set_taborder("2");
            obj.set_text("학번");
            obj.set_cssclass("sta_WF_SearchLbl");
            obj.set_textAlign("right");
            this.DivBg.form.DivContent.form.DivDelHakjeok.addChild(obj.name, obj);

            obj = new Edit("edtHakbeon","79","29","129","22",null,null,null,null,null,null,this.DivBg.form.DivContent.form.DivDelHakjeok.form);
            obj.set_taborder("0");
            this.DivBg.form.DivContent.form.DivDelHakjeok.addChild(obj.name, obj);

            obj = new Button("btnDelHakjeok1",null,"28","179","25","10",null,null,null,null,null,this.DivBg.form.DivContent.form.DivDelHakjeok.form);
            obj.set_taborder("1");
            obj.set_text("4. 학적자료삭제(단건)");
            obj.set_cssclass("btn_WF_Crud");
            this.DivBg.form.DivContent.form.DivDelHakjeok.addChild(obj.name, obj);

            obj = new Static("Static01_00_01_01_00","319","345","100","35",null,null,null,null,null,null,this.DivBg.form.DivContent.form);
            obj.set_taborder("13");
            obj.set_text("↑\r\n35\r\n↓");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("stc_09_00_01_00","10","355","155","22",null,null,null,null,null,null,this.DivBg.form.DivContent.form);
            obj.set_taborder("14");
            obj.set_text("학적자료삭제(단건)");
            obj.set_cssclass("sta_WF_Title02");
            this.DivBg.form.DivContent.addChild(obj.name, obj);

            obj = new Static("Static01_01_00_00_00_01_00","10","372","290","8",null,null,null,null,null,null,this.DivBg.form.DivContent.form);
            obj.set_taborder("15");
            obj.set_text("8");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj.set_taborder("15");
            obj.set_text("9월 입학년도 기준으로 이관처리를 시행합니다.");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.DivBg.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1640,800,this,function(p){});
            obj.set_description("9월입학이관");
        ...
        // User Script
        this.registerScript("ER02_1030201_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): ER02_1030201_M.xfdl(9월입학이관)
        * 작 성         일 명: 백재인
        * 작 성         일 자: 2021/05/10
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        {
        	this.ds_input.setColumn(0, "IN_CREATE_GBCD", "09");
        ...
        this.fn_MkHakbeon = function()
        {
            ...
            var strUrl      = "/prj/ER/ER02/MkHakbeon_1030201_M.do";
            var strInDs     = "ds_input=ds_input";
        ...
        ***********************************************************************/
        ...
        this.fn_HakjeokIgwan = function()
        {
            ...
            var strUrl      = "/prj/ER/ER02/HakjeokIgwan_1030201_M.do";
            var strInDs     = "ds_input=ds_input";
            var strOutDs    = "dsMaster=dsMaster";
            var strArg      = "";
            var GBV_MENUID    = objApp.gv_cutPrgId;
        ...
        ***********************************************************************/
        ...
        this.fn_JanghakIgwan = function()
        {
            ...
            var strUrl      = "/prj/ER/ER02/JanghakIgwan_1030201_M.do";
            var strInDs     = "ds_input=ds_input";
            var strOutDs    = "dsMaster=dsMaster";
            var strArg      = "";
            var GBV_MENUID    = objApp.gv_cutPrgId;
        ...
        ***********************************************************************/
        ...
        /**********************************************************************
                11. 학적자료삭제(단건)
        ***********************************************************************/
        this.DivBg_DivContent_DivDelHakjeok_btnDelHakjeok1_onclick = function(obj,e)
        {
        	this.ds_input.setColumn(0, "IN_CREATE_GBCD", "09");
        	this.ds_input.setColumn(0, "IN_SUHEOM_NO", "");
        	this.ds_input.setColumn(0, "IN_DEUNGROK_YYYY", this.ds_input.getColumn(0, "IN_IPSI_YYYY"));
        	this.ds_input.setColumn(0, "IN_HAKBEON", this.DivBg.form.DivContent.form.DivDelHakjeok.form.edtHakbeon.value);
        	...
        	else if(this.ds_input.getColumn(0, "IN_HAKBEON") == "" || this.ds_input.getColumn(0, "IN_HAKBEON") == null)
        	{
        		this.alert("학번을 입력하세요.");
        		return false;
        	}
         ...
         * 기능 : 마스터 조회 실행
         */
        this.fn_DelHakjeok = function()
        {
            var strSvc      = "DelHakjeok";
            var strUrl      = "/prj/ER/ER02/DelHakjeok_1030201_M.do";
            var strInDs     = "ds_input=ds_input";
            var strOutDs    = "dsMaster=dsMaster";
            var strArg      = "";
            var GBV_MENUID    = objApp.gv_cutPrgId;
         ...
         * 기능 : 조회 후 실행
         */
        this.fn_PostDelHakjeok = function()
        {
            if(this.dsMaster.getColumn(0, "OUT_RESULT") != '00')
        	{
        		this.alert(this.dsMaster.getColumn(0, "OUT_RESULT_CONT"));
        ...
        this.on_initEvent = function()
        {
            ...
            this.DivBg.form.DivContent.form.DivDelHakjeok.form.btnDelHakjeok1.addEventHandler("onclick",this.DivBg_DivContent_DivDelHakjeok_btnDelHakjeok1_onclick,this);
        };
        this.loadIncludeScript("ER02_1030201_M.xfdl");
