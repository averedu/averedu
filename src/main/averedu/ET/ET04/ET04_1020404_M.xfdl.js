(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"PYEONIP_YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"JUYA_GBCD\" type=\"STRING\" size=\"256\"/><Column id=\"PYEONIP_MOJIP_GBCD\" type=\"STRING\" size=\"256\"/><Column id=\"HAKGWA_CD\" type=\"STRING\" size=\"256\"/><Column id=\"JEONGONG_CD\" type=\"STRING\" size=\"256\"/><Column id=\"PYEONIP_HAKNYEON\" type=\"STRING\" size=\"256\"/><Column id=\"SABEON\" type=\"STRING\" size=\"256\"/><Column id=\"MYEONJEOP_YN\" type=\"STRING\" size=\"256\"/><Column id=\"SILGI_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Static("Static01_02_01_00_00","831","0","56","40",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("15");
            obj.set_text("← 56 →");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02_01_00_00_00","1036","0","56","40",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("19");
            obj.set_text("← 56 →");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02_01_00_00_00_00","1215","0","56","40",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("21");
            obj.set_text("← 56 →");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02_00_00_00_00_00_00_00_00","1319","0","10","40",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("23");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02_01_00_00_01","632","0","56","40",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("25");
            obj.set_text("← 56 →");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("stc_02_00_00_00_01","1251","9","80","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("27");
            obj.set_text("담당교수");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboSearchGyosu","1330","9","120","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Static("Static01_01_01_01","0","31","1450","9",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("29");
            obj.set_text("9");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj.set_text("면접내역");
            obj.set_url("ET04::ET04_1020404_T01.xfdl");
            this.Tab.addChild(obj.name, obj);

            obj = new Tabpage("TabPage2",this.Tab);
            obj.set_text("불참내역");
            obj.set_url("ET04::ET04_1020404_T02.xfdl");
            this.Tab.addChild(obj.name, obj);
            ...
            obj = new BindItem("item7","divSearch.form.cboSearchGyosu","value","ds_input","SABEON");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        {
            this._addPreloadList("fdl","ET04::ET04_1020404_T01.xfdl");
            this._addPreloadList("fdl","ET04::ET04_1020404_T02.xfdl");
        };
        
        // User Script
        this.registerScript("ET04_1020404_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): ET04_1020404_M.xfdl(편입학 실기점수관리)
        * 작 성         일 명: 박경민
        * 작 성         일 자: 2021/05/11
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_PreRet = function()
        {
            // 조회조건 셋팅
         	...
         	if (this.gfn_isNull(this.ds_input.getColumn(0, "JIWONHAKGWA_CD")))
         	{
        ...
        ***********************************************************************/
        this.fn_Bulcham = function()
        {
            ...
            var strUrl      = "/prj/ET/ET04/Save_1020404_T01_04.do";
        ...
        ***********************************************************************/
        this.fn_Print = function()
        {
        	...
        	this.gfn_commonUtils_report('ET04/ET04_1020404_M_01.crf', {PYEONIP_YYYY:pyeonipYyyy
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("ET04_1020404_M.xfdl");
