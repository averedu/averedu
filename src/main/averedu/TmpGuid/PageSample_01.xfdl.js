(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_02",null,"3","45","22","btn_03:2",null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_text("필터");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);

            obj = new Button("btn_01",null,"3","45","22","btn_02:2",null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_text("엑셀");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);

            obj = new Button("btn_00",null,"3","45","22","btn_01:2",null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_134",null,"3","45","22","btn_00:2",null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stc_13","1033","420",null,"148","0",null,null,null,null,null,this);
            obj.set_taborder("36");
            obj.set_cssclass("sta_WF_DetailBg");
            this.addChild(obj.name, obj);

            obj = new Static("stc_14","1033","420","150","148",null,null,null,null,null,null,this);
            obj.set_taborder("37");
            obj.set_text("첨부파일");
            obj.set_cssclass("sta_WF_DetailTi");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stc_15","74","84","50","22",null,null,null,null,null,null,this);
            obj.set_taborder("39");
            ...
            obj = new Static("stc_00","0","10","44","20",null,null,null,null,null,null,this.div_01.form);
            obj.set_taborder("2");
            obj.set_text("제목");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.div_01.addChild(obj.name, obj);
            ...
            obj = new Static("stc_01","199","10","68","20",null,null,null,null,null,null,this.div_01.form);
            obj.set_taborder("1");
            obj.set_text("게시여부");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.div_01.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("PageSample_01.xfdl", function() {
        ...
        this.div_01_cal_00_onchanged = function(obj,e)
        {

        };

        this.stc_27_onclick = function(obj,e)
        {

        };

        this.div_01_stc_01_onclick = function(obj,e)
        {
        ...
        this.loadIncludeScript("PageSample_01.xfdl");
