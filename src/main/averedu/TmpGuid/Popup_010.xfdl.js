(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("Div 리사이징 코딩");
            ...
            obj = new Div("Div00","47.25%","51","1.25%",null,null,"20",null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj = new Div("Div01","20","50","45.58%",null,null,"20",null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("Div01");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("Div02",null,"50","49.83%",null,"20","20",null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("Div02");
            this.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("Popup_010.xfdl");
