(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"UNIV_EDUGOAL_CD\" type=\"STRING\" size=\"256\"/><Column id=\"UNIV_EDUGOAL_NM\" type=\"STRING\" size=\"256\"/><Column id=\"SORT\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"80\"/><Column size=\"92\"/><Column size=\"851\"/><Column size=\"60\"/><Column size=\"76\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"년도\"/><Cell col=\"2\" text=\"코드\"/><Cell col=\"3\" text=\"대학교육목표\"/><Cell col=\"4\" text=\"순서\"/><Cell col=\"5\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"1\" textAlign=\"center\" edittype=\"none\" text=\"bind:YYYY\"/><Cell col=\"2\" displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" text=\"bind:UNIV_EDUGOAL_CD\" editmaxlength=\"4\"/><Cell col=\"3\" displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" text=\"bind:UNIV_EDUGOAL_NM\" editmaxlength=\"8\"/><Cell col=\"4\" displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" text=\"bind:SORT\" editmaxlength=\"8\"/><Cell col=\"5\" displaytype=\"combotext\" edittype=\"none\" textAlign=\"center\" editmaxlength=\"8\" text=\"bind:USE_YN\" combodataset=\"dsYn\" combodatacol=\"CODE_NM\" combocodecol=\"CODE\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtMokpyo","874",null,"763","22",null,"3",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_enable("true");
            ...
            obj = new Combo("cboUseYn","622",null,"126","22",null,"3",null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Spin("spnYYYY","122",null,"126","22",null,"3",null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_cssclass("point");
            obj.set_min("0");
            obj.set_max("3000");
            ...
            obj = new Edit("edtSort","372",null,"126","22",null,"3",null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_enable("true");
            ...
            obj.set_description("대학목표관리");
            this.addLayout(obj.name, obj);
            
            // BindItem Information
            obj = new BindItem("item6","edtMokpyo","value","dsMaster","UNIV_EDUGOAL_NM");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item4","cboUseYn","value","dsMaster","USE_YN");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item1","edtSort","value","dsMaster","SORT");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("UC01_2122901_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UC01_2122901_M.xfdl(대학교육목표코드 관리(조회))
        * 작 성         일 명: jiback
        * 작 성         일 자: 2021/10/25
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        /**********************************************************************
                02. 폼 변수 정의
        ***********************************************************************/
        this.lvchkColidDs   = "SORT$USE_YN$UNIV_EDUGOAL_NM";                        // 필수 입력사항 칼럼ID  예)  "commSmcd$commName"
        this.lvchkColNameDs = "순서$사용여부$대학교육목표";
        /**********************************************************************
        ...
        ***********************************************************************/
        this.fn_formInit = function()
        {
            ...
            var strLgcd  = "01032";                           // 공통코드 중분류 코드, 데이터셋 개수와 같아야 한다. 예) "Z01|Z02|Z03"
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function()
        {
            ...
            var strSvc      = "Ret";
            var strUrl      = "/prj/UC/UC01/Retrieve_2122901_M.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Del = function()
        {
            ...
            var strSvc      = "Del";
            var strUrl      = "/prj/UC/UC01/Delete_2122901_M.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Save = function()
        {
            ...
            var strSvc      = "Save";
            var strUrl      = "/prj/UC/UC01/Save_2122901_M.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Copy = function()
        {
            ...
            var strSvc      = "Copy";
            var strUrl      = "/prj/UC/UC01/Copy_2122901_M.do";
            var strInDs     = "ds_input=ds_input:a ";
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("UC01_2122901_M.xfdl");
