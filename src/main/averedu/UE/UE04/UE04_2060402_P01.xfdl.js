(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("장학지급등록마감");
            if (Form == this.constructor)
            {
                this._setFormPosition(260,130);
            }
            ...
            obj = new Static("stc_01_00_01","-2","9","100","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("등록마감일자");
            ...
            obj = new Static("Static01_02_00_00_00_01","98","0","10","42",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Calendar("calMagamDt","108",null,"103","22",null,"9",null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",260,130,this,function(p){});
            obj.set_mobileorientation("landscape");
            obj.set_description("장학지급등록마감");
        ...
        // User Script
        this.registerScript("UE04_2060402_P01.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UE04_2060402_P01.xfdl(장학지급등록마감)
        * 작 성         일 명: jiback
        * 작 성         일 자: 2022/08/09
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	this.divSearch.form.calMagamDt.set_value(this.getOwnerFrame().today)
        };
        ...
        ***********************************************************************/
        ...
        {
        	var magamDt = this.divSearch.form.calMagamDt.value;
        	this.fn_Jigeup(2, magamDt);
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.calMagamDt.addEventHandler("onkeydown",this.divSearch_calSearchBokhakFr_onkeydown,this);
            this.btnClose.addEventHandler("onclick",this.btnClose_onclick,this);
            this.dsCheori.addEventHandler("onrowposchanged",this.dsMaster_onrowposchanged,this);
        };
        this.loadIncludeScript("UE04_2060402_P01.xfdl");
