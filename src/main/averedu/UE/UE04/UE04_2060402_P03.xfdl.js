(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"JANGHAK_YYYY\" type=\"STRING\" size=\"4\"/><Column id=\"HAKGI\" type=\"STRING\" size=\"2\"/><Column id=\"HAKBEON\" type=\"STRING\" size=\"10\"/><Column id=\"JANGHAK_CD\" type=\"STRING\" size=\"10\"/><Column id=\"SEQ\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"HWANSU_SEQ\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"HWANSU_DT\" type=\"STRING\" size=\"8\"/><Column id=\"HWANSU_IPHAK_AMT\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"HWANSU_SUEOP_AMT\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"HWANSU_SAYU\" type=\"STRING\" size=\"100\"/><Column id=\"DEL_YN\" type=\"STRING\" size=\"1\"/></ColumnInfo>");
            ...
            obj._setContents("<ColumnInfo><Column id=\"JANGHAK_YYYY\" type=\"STRING\" size=\"100\"/><Column id=\"HAKGI\" type=\"STRING\" size=\"256\"/><Column id=\"HAKBEON\" type=\"STRING\" size=\"256\"/><Column id=\"HAKSAENG_NM\" type=\"STRING\" size=\"256\"/><Column id=\"JANGHAK_CD\" type=\"STRING\" size=\"256\"/><Column id=\"JANGHAK_NM\" type=\"STRING\" size=\"256\"/><Column id=\"SEQ\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Edit("edtSearchHakbeon","114","9","90","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj.set_description("장학환수내역(재학생)");
        ...
        // User Script
        this.registerScript("UE04_2060402_P03.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UE04_2060402_P03.xfdl(장학환수내역(재학생))
        * 작 성         일 명: jiback
        * 작 성         일 자: 2022/08/11
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        this.fn_formInit = function()
        {
        	...
        	var hakbeon = this.dsCheori.getColumn(0,"HAKBEON");
        	var haksaengNm = this.dsCheori.getColumn(0,"HAKSAENG_NM");
        	...
        	this.divSearch.form.edtSearchHakbeon.set_value(hakbeon);
            this.divSearch.form.edtSearchHaksaengNm.set_value(haksaengNm);
        ...
        ***********************************************************************/
        ...
        {
            // 조회조건 셋팅
        	this.ds_input.setColumn(0, "JANGHAK_YYYY", this.dsCheori.getColumn(0, "JANGHAK_YYYY"));
        ...
        this.fn_Ret = function()
        {
            ...
            var strSvc      = "Ret";
            var strUrl      = "/prj/UE/UE04/Retrieve_2060402_P03.do";
        ...
        ***********************************************************************/
        ...
        this.fn_New = function()
        {
            ...
            var nRow = this.dsMaster.addRow();
         	this.dsMaster.setColumn(nRow, 'JANGHAK_YYYY', this.dsCheori.getColumn(0, "JANGHAK_YYYY"));
         	this.dsMaster.setColumn(nRow, 'HAKGI', this.dsCheori.getColumn(0, "HAKGI"));
         	this.dsMaster.setColumn(nRow, 'HAKBEON', this.dsCheori.getColumn(0, "HAKBEON"));
        ...
        ***********************************************************************/
        ...
        this.fn_Save = function()
        {
            ...
            var strSvc      = "Save";
            var strUrl      = "/prj/UE/UE04/Save_2060402_P03.do";
        ...
        ***********************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.edtSearchHakbeon.addEventHandler("onkeydown",this.divSearch_edtSearchDancheCd_onkeydown,this);
        ...
        this.loadIncludeScript("UE04_2060402_P03.xfdl");
