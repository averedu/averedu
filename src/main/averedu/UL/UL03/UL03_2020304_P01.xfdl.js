(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"HAKGI\" type=\"STRING\" size=\"256\"/><Column id=\"DAEHAK_CD\" type=\"STRING\" size=\"256\"/><Column id=\"HAKGWA_CD\" type=\"STRING\" size=\"256\"/><Column id=\"JEONGONG_CD\" type=\"STRING\" size=\"256\"/><Column id=\"JUYA_GBCD\" type=\"STRING\" size=\"256\"/><Column id=\"ISU_HAKNYEON_CD\" type=\"STRING\" size=\"256\"/><Column id=\"DEL_FLAG\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Static("stc_01_00_01","-15","9","80","22",null,null,null,null,null,null,this.divSearch2.form);
            obj.set_taborder("4");
            obj.set_text("주야");
            obj.set_cssclass("sta_WF_SearchLbl");
            obj.set_textAlign("right");
            ...
            obj = new Static("Static01_02_00_00_00_01","68","0","10","42",null,null,null,null,null,null,this.divSearch2.form);
            obj.set_taborder("5");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("stc_01_00_01_00","183","9","80","22",null,null,null,null,null,null,this.divSearch2.form);
            obj.set_taborder("7");
            obj.set_text("학년");
            obj.set_cssclass("sta_WF_SearchLbl");
            obj.set_textAlign("right");
            ...
            obj = new Static("Static01_02_00_00_00_01_00","262","0","10","42",null,null,null,null,null,null,this.divSearch2.form);
            obj.set_taborder("8");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Combo("cboHaknyeon","271","9","120","22",null,null,null,null,null,null,this.divSearch2.form);
            obj.set_taborder("0");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("CODE_NM");
            obj.set_enable("true");
            ...
            obj = new Static("Static01_02_00_00_00","391","0","27","42",null,null,null,null,null,null,this.divSearch2.form);
            obj.set_taborder("9");
            obj.set_text("27");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Combo("cboJuya","78","9","120","22",null,null,null,null,null,null,this.divSearch2.form);
            obj.set_taborder("10");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("CODE_NM");
            obj.set_enable("true");
            ...
            obj = new Static("stc_01_00_01_00_00","393","9","110","22",null,null,null,null,null,null,this.divSearch2.form);
            obj.set_taborder("11");
            ...
            obj = new Static("Static01_02_00_00_00_01_00_00","504","0","10","42",null,null,null,null,null,null,this.divSearch2.form);
            obj.set_taborder("12");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new CheckBox("chkDel",null,"9","40","22","42",null,null,null,null,null,this.divSearch2.form);
            obj.set_taborder("13");
            ...
            obj = new BindItem("item4","divSearch2.form.cboHaknyeon","value","dsMaster","ISU_HAKNYEON_CD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item5","divSearch2.form.cboJuya","value","dsMaster","JUYA_GBCD");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item7","divSearch2.form.chkDel","value","dsMaster","DEL_FLAG");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("UL03_2020304_P01.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UL03_2020304_P01.xfdl(개설강좌생성)
        * 작 성         일 명: jiback
        * 작 성         일 자: 2022/07/19
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        {
        	var strDs    = "dsHakgi|dsJuya|dsHaknyeon";
        ...
        ***********************************************************************/
        ...
        this.fn_PreNew = function()
        {
        	...
        	var result = this.gfn_confirm("개설강좌를 생성하시겠습니까?", "저장","", "question" );
        	if(result == 0)
        	{
        		return false;
        	}
        ...
        this.fn_New = function()
        {
            ...
            var strSvc      = "New";
            var strUrl      = "/prj/UL/UL03/Save_2020304_P01.do";
        ...
        {
        	var outCode	= this.dsOut.getColumn(0, "OUT_CODE");
        	var outMsg	= this.dsOut.getColumn(0, "OUT_MSG");
        	if(outMsg == ""){
        		// 개성강좌생성 실패
        		this.alert("개설강좌생성 중 오류가 발생하였습니다.");
        	}else{
        		// 개성강좌생성 성공
        		this.alert(outMsg);
        		this.close("CLOSE");
        ...
        ***********************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch2.form.stc_01_00_01_00_00.addEventHandler("onclick",this.divSearch_stc_01_00_onclick,this);
        };
        this.loadIncludeScript("UL03_2020304_P01.xfdl");
