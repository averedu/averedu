(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staRowCnt2","647","9",null,"24","870",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("[총 <fc v=\'red\'><b v=\'true\'>0 </b></fc>건]");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);
            ...
            obj.set_autoupdatetype("itemselect");
            obj.set_cellclickbound("cell");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"67\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"NO\"/><Cell col=\"2\" text=\"년도\"/><Cell col=\"3\" text=\"학기\"/><Cell col=\"4\" text=\"기준시수\"/><Cell col=\"5\" text=\"담당시수\"/><Cell col=\"6\" text=\"인정시수\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"2\" text=\"bind:YYYY\" edittype=\"expr:dataset.getRowType(currow) == &quot;2&quot; ? &quot;text&quot; : &quot;none&quot;\"/><Cell col=\"3\" text=\"bind:HAKGI\" displaytype=\"combotext\" edittype=\"expr:dataset.getRowType(currow) == &quot;2&quot; ? &quot;combo&quot; : &quot;none&quot;\" combodataset=\"dsHakgi\" combodatacol=\"CODE_NM\" combocodecol=\"CODE\"/><Cell col=\"4\" text=\"bind:GIJUN_SISU\" displaytype=\"normal\" combodataset=\"dsJuGaekgwansikGb\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\" edittype=\"text\"/><Cell col=\"5\" text=\"bind:DAMDANG_SISU\" textAlign=\"center\" edittype=\"text\" displaytype=\"normal\"/><Cell col=\"6\" text=\"bind:INJEONG_SISU\" edittype=\"none\" displaytype=\"normal\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("UL06_2020601_T02.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UL06_2020601_T01.xfdl(비전임)
        * 작 성         일 명: jiback
        * 작 성         일 자: 2022/07/14
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_PreRet = function(data)
        {
        	...
        	this.ds_input.setColumn(0, "TAB_INDEX", "1");
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("UL06_2020601_T02.xfdl");
