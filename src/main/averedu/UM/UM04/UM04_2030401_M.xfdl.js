(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"HAKGWA_NM\" type=\"STRING\" size=\"256\"/><Column id=\"HAKNYEON\" type=\"STRING\" size=\"256\"/><Column id=\"HAKBEON\" type=\"STRING\" size=\"256\"/><Column id=\"HAKSAENG_NM\" type=\"STRING\" size=\"256\"/><Column id=\"CHWIDEUK_HAKJEOM\" type=\"STRING\" size=\"256\"/><Column id=\"JEOMSU_AVG\" type=\"STRING\" size=\"256\"/><Column id=\"PYEONGJEOM_AVG\" type=\"STRING\" size=\"256\"/><Column id=\"B_CHWIDEUK_HAKJEOM\" type=\"STRING\" size=\"256\"/><Column id=\"B_JEOMSU_AVG\" type=\"STRING\" size=\"256\"/><Column id=\"B_PYEONGJEOM_AVG\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Div("divSearch","0","0",null,"75","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("Static01_01_00","0","66","1640","9",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("27");
            obj.set_text("9");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("stc_01_00_02","-6","37","1000","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("29");
            obj.set_text("※ 당해학기 외 성적사정 시 성적 데이터 변동이 있을 수 있으므로 당해학기 외에 이미 지나간 학년도/학기의 성적사정은 되도록 자제해주시기 바랍니다.\r\n※ 학번을 입력하면 학생 1명에 대해서만 성적사정이 가능합니다.");
            obj.set_cssclass("sta_WF_SearchLbl");
            obj.set_textAlign("left");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static01_00","800","75","35","35",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("↑\r\n35\r\n↓");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("stRowCnt","140","81","300","24",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("[총 <fc v=\'red\'><b v=\'true\'>0 </b></fc>건]");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);

            obj = new Static("stc_09_00","0","78","140","31",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("성적사정결과 목록");
            obj.set_cssclass("sta_WF_Title02");
            this.addChild(obj.name, obj);

            obj = new Static("Static01_01_00_00_00","0","102","1640","8",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("8");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Grid("grdMaster","0","110",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"125\"/><Column size=\"70\"/><Column size=\"91\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"No\"/><Cell col=\"1\" rowspan=\"2\" text=\"학과/전공\"/><Cell col=\"2\" rowspan=\"2\" text=\"학년\"/><Cell col=\"3\" rowspan=\"2\" text=\"학번\"/><Cell col=\"4\" rowspan=\"2\" text=\"성명\"/><Cell col=\"5\" colspan=\"3\" text=\"학기성적\"/><Cell col=\"8\" colspan=\"3\" text=\"총성적\"/><Cell row=\"1\" col=\"5\" text=\"취득학점\"/><Cell row=\"1\" col=\"6\" text=\"백분율\"/><Cell row=\"1\" col=\"7\" text=\"평점\"/><Cell row=\"1\" col=\"8\" text=\"취득학점\"/><Cell row=\"1\" col=\"9\" text=\"백분율\"/><Cell row=\"1\" col=\"10\" text=\"평점\"/></Band><Band id=\"body\"><Cell expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"1\" text=\"bind:HAKGWA_NM\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:HAKNYEON\"/><Cell col=\"3\" text=\"bind:HAKBEON\"/><Cell col=\"4\" text=\"bind:HAKSAENG_NM\"/><Cell col=\"5\" text=\"bind:CHWIDEUK_HAKJEOM\" textAlign=\"right\"/><Cell col=\"6\" text=\"bind:JEOMSU_AVG\" textAlign=\"right\"/><Cell col=\"7\" text=\"bind:PYEONGJEOM_AVG\" textAlign=\"right\"/><Cell col=\"8\" text=\"bind:B_CHWIDEUK_HAKJEOM\" textAlign=\"right\"/><Cell col=\"9\" text=\"bind:B_JEOMSU_AVG\" textAlign=\"right\"/><Cell col=\"10\" text=\"bind:B_PYEONGJEOM_AVG\" textAlign=\"right\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1640,800,this,function(p){});
            obj.set_description("성적사정");
        ...
        // User Script
        this.registerScript("UM04_2030401_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UM04_2030401_M.xfdl(성적사정)
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/07/22
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        this.fn_formInit = function()
        {
            ...
            strDs    = "dsHakgi";                    // 데이터를 받을 데이터셋리스트     예) "DS_CODE01|DS_CODE02|DS_CODE03"
            strLgcd  = "00022";                           // 공통코드 중분류 코드, 데이터셋 개수와 같아야 한다. 예) "Z01|Z02|Z03"
            strComb  = "X";                                   // 콤보옵션 (T:전체, S:선택, N:공백, X:해당사항없음)
            strOptn  = "";                                      // 조건문 " AND COMM_IT02 = '" + vip + "'|||";
            svcId    = "Init";
        ...
        ***********************************************************************/
        ...
        {
            var strSvc      = "Ret";
            var strUrl      = "/prj/UM/UM04/Retrieve_2030401_MList.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Sajung = function()
        {
        	...
        	var haksaengNm 	= this.ds_input.getColumn(0, "HAKSAENG_NM");

        	if (this.gfn_isNull(yyyy)) {
        		this.alert("학년도를 입력해야합니다.");
        		return;
        	}

        	if (this.gfn_isNull(hakgi)) {
        		this.alert("학기를 입력해야합니다.");
        		return;
        	}

        	if (!this.gfn_isNull(haksaengNm)) {
        		if (this.gfn_isNull(hakbeon)) {
        			this.alert("학번과 성명 모두 입력해야 해당 학생을 성적사정할 수 있습니다.");
        			return;
        		}

        		var result = this.gfn_confirm( "정말 해당 학생을 성적사정하시겠습니까?", "성적사정","", "question" );
        		if (result) {
        			    var strSvc      = "Save";
        				var strUrl      = "/prj/UM/UM04/Save_2030401_M.do";
        		...
        		var result = this.gfn_confirm( "정말 성적사정하시겠습니까?", "성적사정","", "question" );
        		if (result) {
        			    var strSvc      = "Save";
        				var strUrl      = "/prj/UM/UM04/Save_2030401_MList.do";
        				var strInDs     = "ds_input=ds_input:a";
        				var strOutDs    = "dsMaster=dsMaster";
        				var strArg      = "";
        				var GBV_MENUID    = objApp.gv_cutPrgId;
        ...
        this.loadIncludeScript("UM04_2030401_M.xfdl");
