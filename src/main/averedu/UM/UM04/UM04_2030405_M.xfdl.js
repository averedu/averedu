(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"HAKGI\" type=\"STRING\" size=\"256\"/><Column id=\"HAKGWA_NM\" type=\"STRING\" size=\"256\"/><Column id=\"JUYA_GBNM\" type=\"STRING\" size=\"256\"/><Column id=\"HAKNYEON\" type=\"STRING\" size=\"256\"/><Column id=\"HAKBEON\" type=\"STRING\" size=\"256\"/><Column id=\"HAKSAENG_NM\" type=\"STRING\" size=\"256\"/><Column id=\"JEOESAYU\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Static("stRowCnt","160","48","200","24",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("[총 <fc v=\'red\'><b v=\'true\'>0 </b></fc>건]");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);

            obj = new Static("stc_09_00","0","44","160","31",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("석차제외 대상자 목록");
            ...
            obj = new Grid("grdMaster","0","76",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"400\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"학년도\"/><Cell col=\"2\" text=\"학기\"/><Cell col=\"3\" text=\"학과/전공\"/><Cell col=\"4\" text=\"주야구분\"/><Cell col=\"5\" text=\"학년\"/><Cell col=\"6\" text=\"학번\"/><Cell col=\"7\" text=\"성명\"/><Cell col=\"8\" text=\"제외사유\"/></Band><Band id=\"body\"><Cell expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"1\" text=\"bind:YYYY\" edittype=\"expr:dataset.getRowType(currow) == 2 ? &apos;text&apos; : &apos;none&apos;\"/><Cell col=\"2\" text=\"bind:HAKGI\" displaytype=\"combotext\" combodataset=\"dsHakgi\" combodatacol=\"CODE_NM\" combocodecol=\"CODE\" edittype=\"expr:dataset.getRowType(currow) == 2 ? &apos;combo&apos; : &apos;none&apos;\"/><Cell col=\"3\" text=\"bind:HAKGWA_NM\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:JUYA_GBNM\"/><Cell col=\"5\" text=\"bind:HAKNYEON\"/><Cell col=\"6\" text=\"bind:HAKBEON\" expandshow=\"hide\"/><Cell col=\"7\" text=\"bind:HAKSAENG_NM\" expandshow=\"show\"/><Cell col=\"8\" text=\"bind:JEOESAYU\" edittype=\"text\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1640,800,this,function(p){});
            obj.set_description("석차제외대상자관리");
        ...
        // User Script
        this.registerScript("UM04_2030405_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UM04_2030405_M.xfdl(석차제외대상자관리)
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/07/27
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        /**********************************************************************
                02. 폼 변수 정의
        ***********************************************************************/
        this.lvchkColidDs   = "YYYY$HAKGI$HAKBEON$JEOESAYU";                        // 필수 입력사항 칼럼ID  예)  "commSmcd$commName"
        this.lvchkColNameDs = "학년도$학기$학번$제외사유";
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function()
        {
            ...
            var strSvc      = "Ret";
            var strUrl      = "/prj/UM/UM04/Retrieve_2030405_MList.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Del = function()
        {
            ...
            var strSvc      = "Del";
            var strUrl      = "/prj/UM/UM04/Delete_2030405_MList.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Save = function()
        {
            ...
            var strSvc      = "Save";
            var strUrl      = "/prj/UM/UM04/Save_2030405_MList.do";
        ...
        ***********************************************************************/
        ...
        this.fn_setCallGrdHakbeonPopup = function(strSearchValue)
        {
        	...
        	if(!this.gfn_isNull(strSearchValue))
        	{
        		...
        		var strUrl 		= "/prj/com/Retrieve_P04.do";
        		var strInDs  	= "ds_input=ds_input1";
        		var strOutDs 	= "dsGrdHakbeon=dsMaster";
        		var strArg 		= "";
        ...
        this.loadIncludeScript("UM04_2030405_M.xfdl");
