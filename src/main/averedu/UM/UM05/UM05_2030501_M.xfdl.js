(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_00","230","42","1410","35",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("↑\r\n35\r\n↓");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("stc_09_00","0","45","200","31",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("성적 미입력 과목 미리보기");
        ...
        // User Script
        this.registerScript("UM05_2030501_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UM05_2030501_M.xfdl(업체공통클래스(샘풀) 관리(조회))
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/08/05
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function()
        {
        	...
        	var PRT_INFO = DEPT_NM + ' ' + USER_NM; // user_ip + ' ' + dept_nm + ' ' + user_nm 순
        	...
        	this.wbMaster.set_url(this.gfn_commonUtils_report2('UM05/UM05_2030501_M.crf',  param));
        };
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("UM05_2030501_M.xfdl");
