(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"HAKGI\" type=\"STRING\" size=\"256\"/><Column id=\"MIDAL_HAKJEOM\" type=\"STRING\" size=\"256\"/><Column id=\"CHOGWA_HAKJEOM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Edit("edtSearchMidal","505","9","120","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_enable("true");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("stc_01_00_01_00_00","625","9","105","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("14");
            obj.set_text("초과학점");
            obj.set_cssclass("sta_WF_SearchLbl");
            obj.set_textAlign("right");
            ...
            obj = new Static("Static01_02_00_00_00_01_00_00","730","0","10","42",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("16");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Edit("edtSearchChogwa","740","9","120","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("17");
            obj.set_enable("true");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("stc_09_00","0","45","220","31",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("학점초과/미당자명부 미리보기");
            ...
            obj = new BindItem("item2","divSearch.form.edtSearchMidal","value","ds_input","MIDAL_HAKJEOM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearch.form.edtSearchChogwa","value","ds_input","CHOGWA_HAKJEOM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("UM05_2030502_M.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("UM05_2030502_M.xfdl");
