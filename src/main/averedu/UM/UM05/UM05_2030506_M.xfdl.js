(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("성적평가분포현황(학과별)");
            ...
            obj.set_taborder("2");
            obj.set_text("성적평가분포현황(학과별) 미리보기");
        ...
        // User Script
        this.registerScript("UM05_2030506_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UM05_2030506_M.xfdl
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/08/08
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function()
        {
        	...
        	this.wbMaster.set_url(this.gfn_commonUtils_report2('UM05/UM05_2030506_M.crf',  param));
        };
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("UM05_2030506_M.xfdl");
