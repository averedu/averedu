(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("성적평가분포현황(교수별)");
            ...
            obj._setContents("<ColumnInfo><Column id=\"YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"HAKGI\" type=\"STRING\" size=\"256\"/><Column id=\"DAMDANGGYOSU_CD\" type=\"STRING\" size=\"256\"/><Column id=\"DAMDANGGYOSU_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Static("stc_01_00_00","390","9","90","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("교수명");
            obj.set_cssclass("sta_WF_SearchLbl");
            obj.set_textAlign("right");
            ...
            obj = new Edit("edtDamdangCd","490","9","150","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_enable("false");
            obj.set_maxlength("3");
            this.divSearch.addChild(obj.name, obj);

            obj = new Button("btnDamdang","643","9","22","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_cssclass("btn_WF_PopSrch");
            obj.set_text("");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtDamdangNm","668","9","154","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_enable("true");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_02_00_00_00_01_00","480","0","10","42",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("15");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj.set_taborder("1");
            obj.set_text("성적평가분포현황(교수별) 미리보기");
        ...
        // User Script
        this.registerScript("UM05_2030507_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UM05_2030507_M.xfdl
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/08/09
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function()
        {
        	...
        	this.wbMaster.set_url(this.gfn_commonUtils_report2('UM05/UM05_2030507_M.crf',  param));
        };
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("UM05_2030507_M.xfdl");
