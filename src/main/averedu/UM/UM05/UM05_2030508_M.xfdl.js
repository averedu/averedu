(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("성적평가분포현황(교수별-학과)");
            ...
            obj.set_taborder("1");
            obj.set_text("성적평가분포현황(교수별-학과) 미리보기");
        ...
        // User Script
        this.registerScript("UM05_2030508_M.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("UM05_2030508_M.xfdl");
