(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("UM05_2030509_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UM05_2030509_M.xfdl
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/08/09
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function()
        {
        	...
        	this.wbMaster.set_url(this.gfn_commonUtils_report2('UM05/UM05_2030509_M.crf',  param));
        };
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("UM05_2030509_M.xfdl");
