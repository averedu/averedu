(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("교직적성및인성검사 신청기간관리");
            ...
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"256\"/><Column id=\"YYYY\" type=\"STRING\" size=\"4\"/><Column id=\"HOECHA\" type=\"STRING\" size=\"1\"/><Column id=\"FR_DT\" type=\"STRING\" size=\"8\"/><Column id=\"TO_DT\" type=\"STRING\" size=\"8\"/><Column id=\"HYEONJAE_YN\" type=\"STRING\" size=\"1\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"85\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\"/><Cell col=\"1\" text=\"No\"/><Cell col=\"2\" text=\"년도\"/><Cell col=\"3\" text=\"회차\"/><Cell col=\"4\" text=\"신청기간From\"/><Cell col=\"5\" text=\"신청기간To\"/><Cell col=\"6\" text=\"현재신청여부\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\" editmaxlength=\"1\"/><Cell col=\"1\" expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"2\" text=\"bind:YYYY\"/><Cell col=\"3\" text=\"bind:HOECHA\" edittype=\"text\" editinputtype=\"digit\"/><Cell col=\"4\" text=\"bind:FR_DT\" displaytype=\"calendarcontrol\" edittype=\"date\" calendardateformat=\"yyyy-MM-dd\" calendardisplaynulltype=\"none\"/><Cell col=\"5\" text=\"bind:TO_DT\" edittype=\"date\" displaytype=\"calendarcontrol\" calendardateformat=\"yyyy-MM-dd\" calendardisplaynulltype=\"none\"/><Cell col=\"6\" text=\"bind:HYEONJAE_YN\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("UP01_2040105_M.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("UP01_2040105_M.xfdl");
