(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("교원자격번호생성 팝업");
            ...
            obj._setContents("<ColumnInfo><Column id=\"JOLEOP_YYYY\" type=\"STRING\" size=\"256\"/><Column id=\"JOLEOP_HAKGI\" type=\"STRING\" size=\"256\"/><Column id=\"SAJEONG_GB\" type=\"STRING\" size=\"256\"/><Column id=\"HAKBEON\" type=\"STRING\" size=\"256\"/><Column id=\"HAKSAENG_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj.set_preload("true");
            obj.set_useclientlayout("true");
            obj._setContents("<ColumnInfo><Column id=\"GYOJIKSAJEONG_CNT\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"BALGEUP_CNT\" type=\"BIGDECIMAL\" size=\"22\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_result", this);
            obj._setContents("<ColumnInfo><Column id=\"OUT_MSG\" type=\"STRING\" size=\"65532\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("stt_joleopYyyy","0","9","125","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("0");
            ...
            obj = new Spin("spn_joleopYyyy","135","9","100","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("1");
            obj.set_readonly("true");
            this.divInput.addChild(obj.name, obj);

            obj = new Combo("cbo_joleopHakgi","238","9","100","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("2");
            ...
            obj = new Static("Static01_02_00","0","0","27","267",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("4");
            obj.set_text("27");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static01_02_00_00_00","125","0","10","267",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("7");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("stt_chwideukDt00","0","39","125","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("8");
            obj.set_text("자격번호생성구분");
            obj.getSetter("onitemchanged").set("divSearch_cbo_jagyeokjongbyeolCd_onitemchanged");
            obj.set_textAlign("right");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.divInput.addChild(obj.name, obj);

            obj = new Radio("rdoSajeongGb","135","39","150","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("9");
            ...
            obj = new Grid("grdMaster","135","68","305","170",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("10");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"40\"/><Column size=\"140\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"none\"/><Cell col=\"1\" text=\"No\"/><Cell col=\"2\" text=\"학과\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\" editmaxlength=\"1\"/><Cell col=\"1\" expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"2\" text=\"bind:IN_HAKGWA_NM\" textAlign=\"left\"/></Band></Format></Formats>");
            this.divInput.addChild(obj.name, obj);

            obj = new Static("Static01_01_00_00_02_00_00_00","0","238",null,"9","0",null,null,null,null,null,this.divInput.form);
            obj.set_taborder("11");
            obj.set_text("9");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("stt_chwideukDt00_00","0","247","125","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("12");
            obj.set_text("학번/성명");
            obj.getSetter("onitemchanged").set("divSearch_cbo_jagyeokjongbyeolCd_onitemchanged");
            obj.set_textAlign("right");
            ...
            obj = new Edit("edtSearchHakbeon","135","247","120","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("13");
            obj.set_enable("false");
            obj.set_maxlength("3");
            this.divInput.addChild(obj.name, obj);

            obj = new Button("btnHakbeon","258","247","22","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("14");
            obj.set_cssclass("btn_WF_PopSrch");
            this.divInput.addChild(obj.name, obj);

            obj = new Edit("edtSearchName","283","247","120","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("15");
            obj.set_enable("true");
            this.divInput.addChild(obj.name, obj);

            obj = new Static("Static01_01_00_00_02_00_00_00_00","0","267",null,"20","0",null,null,null,null,null,this.divInput.form);
            obj.set_taborder("16");
            obj.set_text("20");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static00","10","295","340","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("17");
            obj.set_text("※ 학과별 처리시 체크한 학과만 교원자격번호가 생성됩니다.");
            obj.set_cssclass("req");
            this.divInput.addChild(obj.name, obj);

            obj = new Static("Static03","10","320","440","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("18");
            obj.set_text("※ 학과별 처리시 교원자격증 발급내역이 있는 학생이 있는 경우 학과별 처리를");
            obj.set_cssclass("req");
            this.divInput.addChild(obj.name, obj);

            obj = new Static("Static02","10","345","425","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("19");
            obj.set_text("　 할 수 없습니다. ");
            obj.set_cssclass("req");
            this.divInput.addChild(obj.name, obj);

            obj = new Static("Static01","10","370","430","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("20");
            obj.set_text("※ 학번/성명을 입력하면 개별 처리가 됩니다.(교원자격 미취득자는 처리안됨)");
            obj.set_cssclass("req");
            this.divInput.addChild(obj.name, obj);

            obj = new Static("Static04","10","395","470","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("21");
            obj.set_text("※ 개별 처리시 교원자격증 발급내역이 있는 경우 교원자격번호를 생성할 수 없습니다.");
            obj.set_cssclass("req");
            this.divInput.addChild(obj.name, obj);

            obj = new Button("btn_jagyeog","160","425","120","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("22");
            obj.set_text("교원자격번호 생성");
            obj.set_cssclass("btn_WF_Crud");
            this.divInput.addChild(obj.name, obj);

            obj = new Button("btn_close","284","425","50","20",null,null,null,null,null,null,this.divInput.form);
            obj.set_taborder("23");
            obj.set_text("닫기");
            obj.set_cssclass("btn_WF_Crud");
            this.divInput.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("UP02_2040202_P03.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UP02_2040202_P03.xfdl(교원자격번호생성)
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/08/24
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.fn_searchSajeongHakgwa = function() {
            ...
            var strUrl      = "/prj/UP/UP02/Retrieve_2040202_P03List.do";
        ...
        this.divInput_btn_jagyeog_onclick = function(obj,e) {
        	// 교원자격번호 생성은 학과 단위로 처리한다.
        	// 졸업년도학기로 생성 후 추가로 교원자격번호를 생성해야 하는 경우는 신규로 개별처리 해야 함
        	// 학과에서 1명이라도 교원자격번호가 등록되어있고 발급내역이 있으면 학과단위로 생성할 수 없음, 해당 학번으로 개별생성해야 함
        	...
        	{
        		if (this.gfn_isNull(this.divInput.form.edtSearchHakbeon.value))
        		{
        ...
        this.fn_count = function()
        {
            ...
            var strUrl      = "/prj/UP/UP02/Count_2040202_P03List.do";
        ...
        this.fn_PostSajeongCnt = function()
        {
        	...
        	var gb = this.divInput.form.rdoSajeongGb.value;
        	// 교원자격 취득자 정보가 있는지
        	if (this.dsSajeongCnt.getColumn(0, "GYOJIKSAJEONG_CNT") == 0)
        	{
        		txt3 = (gb == "1" ? txt2 + " 교원자격 취득자가 없습니다." : "해당 학생은 교원자격 취득자가 아닙니다.");
        		this.alert(txt3);
        		return;
        	}
        	...
        	{
        		txt3 = (gb == "1" ? txt2 + " 교원자격 취득자 중 교원자격증 발급내역이 있는 학생이 있습니다.\n교원자격번호를 생성할 수 없습니다." : "교원자격증 발급내역이 있는 학생입니다.\n교원자격번호를 생성할 수 없습니다.");
        		this.alert(txt3);
        		return;
        	}
            ...
            var result = this.gfn_confirm(txt + "\n\n(으)로 교원자격번호를 생성하시겠습니까?\n\n교원자격번호 데이터가 존재하면 삭제 후 다시 생성됩니다.", "교원자격번호 생성", "", "question");
            if(result == 0) return;
        	...
        	this.fn_createJagyeogNo();
        }

        this.fn_createJagyeogNo = function()
        {
            var strSvc      = "Jagyeog";
        	var strUrl      = "/prj/UP/UP02/Create_2040202_JagyeogNo.do";
        	var strInDs     = "ds_input=ds_input:a ";
        		strInDs    += "dsMaster=dsMaster:u";
            var strOutDs    = "";
            var strArg      = "";
        ...
        this.fn_PostJagyeog = function()
        {
        	this.alert("교원자격번호 생성처리가 완료되었습니다.");
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.divInput.form.btn_jagyeog.addEventHandler("onclick",this.divInput_btn_jagyeog_onclick,this);
            this.divInput.form.btn_close.addEventHandler("onclick",this.divInput_btn_close_onclick,this);
        };
        this.loadIncludeScript("UP02_2040202_P03.xfdl");
