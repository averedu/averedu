(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DEUNGROK_YYYY\" type=\"STRING\" size=\"4\"/><Column id=\"HAKGI\" type=\"STRING\" size=\"10\"/><Column id=\"HWANBUL_GIJUN_GBCD\" type=\"STRING\" size=\"10\"/><Column id=\"FR_ILSU\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"TO_ILSU\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"BIGO\" type=\"STRING\" size=\"500\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"35\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"270\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"No\"/><Cell col=\"1\" rowspan=\"2\" text=\"등록년도\"/><Cell col=\"2\" rowspan=\"2\" text=\"학기\"/><Cell col=\"3\" rowspan=\"2\" text=\"환불 구분\"/><Cell col=\"4\" colspan=\"2\" text=\"학기 개시일\"/><Cell col=\"6\" rowspan=\"2\" text=\"비고\"/><Cell row=\"1\" col=\"4\" text=\"시작일수\"/><Cell row=\"1\" col=\"5\" text=\"종료일수\"/></Band><Band id=\"body\"><Cell expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\"/><Cell col=\"1\" text=\"bind:DEUNGROK_YYYY\" combodataset=\"ds_업무구분_grid\" combocodecol=\"cd\" combodatacol=\"cdNm\"/><Cell col=\"2\" text=\"bind:HAKGI\" displaytype=\"combotext\" edittype=\"none\" combodataset=\"dsHakgi\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"3\" text=\"bind:HWANBUL_GIJUN_GBCD\" displaytype=\"expr:dataset.getRowType(currow) == &apos;2&apos; ? &apos;combocontrol&apos; : &apos;combotext&apos;\" edittype=\"expr:dataset.getRowType(currow) == &apos;2&apos; ? &apos;combo&apos; : &apos;none&apos;\" combodataset=\"dsHwanbul\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"4\" text=\"bind:FR_ILSU\" edittype=\"text\" displaytype=\"text\" textAlign=\"center\" editmaxlength=\"3\" editinputtype=\"number\"/><Cell col=\"5\" edittype=\"text\" text=\"bind:TO_ILSU\" displaytype=\"text\" textAlign=\"center\" editmaxlength=\"3\" editinputtype=\"number\"/><Cell col=\"6\" text=\"bind:BIGO\" displaytype=\"text\" edittype=\"text\" editmaxlength=\"166\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("UR01_2050103_M.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): UR01_2050103_M.xfdl(등록금 환불 기준 관리 관리(조회))
        * 작 성         일 명: jiback
        * 작 성         일 자: 2021/10/06
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        /**********************************************************************
                02. 폼 변수 정의
        ***********************************************************************/
        this.lvchkColidDs   = "HWANBUL_GIJUN_GBCD$FR_ILSU$TO_ILSU";
        this.lvchkColNameDs = "환불구분$시작일수$종료일수";
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        {
            var strDs    = "dsHakgi|dsHwanbul";                    // 데이터를 받을 데이터셋리스트     예) "DS_CODE01|DS_CODE02|DS_CODE03"
            var strLgcd  = "00022|03004";                           // 공통코드 중분류 코드, 데이터셋 개수와 같아야 한다. 예) "Z01|Z02|Z03"
        ...
        ***********************************************************************/
        ...
        this.fn_Ret = function()
        {
            ...
            var strSvc      = "Ret";
            var strUrl      = "/prj/UR/UR01/Retrieve_2050103_M.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Del = function()
        {
            ...
            var strSvc      = "Del";
            var strUrl      = "/prj/UR/UR01/Delete_2050103_M.do";
        ...
        ***********************************************************************/
        ...
        this.fn_Save = function()
        {
            ...
            var strSvc      = "Save";
            var strUrl      = "/prj/UR/UR01/Save_2050103_M.do";
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("UR01_2050103_M.xfdl");
