...
if (!nexacro._PanelSlot)
{
    ...
    nexacro._PanelSlot = function (_target, _static)
    {
        ...
        this._slot_status = 0;          // slot status  : 0:none,       1:expand,       -1:collpased    (tree stat)     // TODO : visible/status/multi 통합
...
if (!nexacro._Panel)
{
    ...
    //  this._panel_showslot = false;   // panel allow showslot             = true:allowed      false:not allowed
        ...
        this._panel_fixrlead = 0;       // panel row fixed lead count       =!0>=:fixed row lead count      // TODO:rowcount와 통합
        this._panel_fixrtail = 0;       // panel row fixed tail count       =!0>=:fixed row tail count      // TODO:rowcount와 통합
        this._panel_fixclead = 0;       // panel col fixed lead count       =!0>=:fixed col lead count      // TODO:colcount와 통합
        this._panel_fixctail = 0;       // panel col fixed tail count       =!0>=:fixed col tail count      // TODO:colcount와 통합
...
if (!nexacro._ScrollManager)
{
    ...
    //  this.rounddirec = 0;        // roundrobin h/v scroll,   panel에서 처리
    //  this.headsumfix = 0;        // headsum fix scroll,      panel에서 처리
    //  this.scrollcont = 0;        // infinit scroll,          panel에서 처리
    //  this.scrollover = 0;        // scroll over mode,        사용자가 처리
    };
...
if (!nexacro.ComplexComponent)
{
    ...
    */
    ...
    _pComplexComponent._use_headitem = false;           // HeadItem 사용시 개별 지정, Override 필요.                 TODO : 변수통합
    _pComplexComponent._use_tailitem = false;           // TailItem 사용시 개별 지정, Override 필요.                 TODO : 변수통합
    _pComplexComponent._use_markitem = false;           // MarkItem 사용시 개별 지정, Override 필요.                 TODO : 변수통합
    _pComplexComponent._use_clientem = false;           // ClientElement 사용시 개별 지정, Override 필요.            TODO : 변수통합
    _pComplexComponent._use_partitem = false;           // Item Partial Create 시 개별 지정, Override 필요.          TODO : 변수통합
    _pComplexComponent._add_partitem = 1;               // Item Partial Create 시 개별 지정, Override 필요.          TODO : 변수통합
    _pComplexComponent._acc_partitem = 1;               // Item Partial Create 시 개별 지정, Override 필요.          TODO : 변수통합
    ...
    /*
    _pComplexComponent._is_nc_head  = false;            // NC Header 사용시 개별 지정, Override 필요.                TODO : 변수통합    
    _pComplexComponent._is_nc_foot  = false;            // NC Footer 사용시 개별 지정, Override 필요.                TODO : 변수통합
    _pComplexComponent._is_nc_lead  = false;            // NC Indicator 사용시 개별 지정, Override 필요.             TODO : 변수통합
    _pComplexComponent._is_nc_tail = false;             // NC Scrollbar 사용시 개별 지정, Override 필요.             TODO : 변수통합
    _pComplexComponent._is_nc_leadtop  = false;         // NC Corner 사용시 개별 지정, Override 필요.                TODO : 변수통합
    _pComplexComponent._is_nc_tailtop = false;          // NC Corner 사용시 개별 지정, Override 필요.                TODO : 변수통합
    _pComplexComponent._is_nc_leadbottom  = false;      // NC Corner 사용시 개별 지정, Override 필요.                TODO : 변수통합
    _pComplexComponent._is_nc_tailbottom = false;       // NC Corner 사용시 개별 지정, Override 필요.                TODO : 변수통합
    */
    // TODO: _use+_is_nc 통합하여 1개 flag로 처리 --> _use_scroll/_use_expand
    _pComplexComponent._is_nc_scroll = false;           // NC Scroll 사용시 개별 지정, Override 필요.
    _pComplexComponent._is_nc_expand = false;           // NC Expand 사용시 개별 지정, Override 필요.
    _pComplexComponent._use_scrollmanager = false;      // NC Scroll + Panel Overflow Partial Slot 사용시 필수 지정, Override 필요. TODO : 필수속성으로 내부처리
    _pComplexComponent._use_expandmanager = false;      // NC Expand + Panel Overflow Expand Popup 사용시 필수 지정, Override 필요. TODO : 필수속성으로 내부처리
    _pComplexComponent._use_scrollcover = true;         // Scroll Track시 개별 지정, Override 필요.
    _pComplexComponent._use_scrolltrack = true;         // Scroll Track시 개별 지정, Override 필요.
    ...
    */
    ...
    // [component.layout.panel.popup:getsize]        // Override 없음
    ...
    */
    ...
    // [component.layout.items:set]                 // 내부 사용 interface (Contents Editor)
    ...
    // [component.layout.items:getchild]            // override는 basic component내에서만 가급적 최소화
    ...
    */
    ...
    _pComplexComponent._use_select = false;                // Select 지원시 설정
    ...
    */
    ...
    // [component.scroll:init]                      // 기존 Component 동일 interface 유지
    /*
    ...
    */
                                                                                    // scroll event aniframe 사용시 추가, TODO : Emulator 확인
    ...
    */
    ...
    // [object.status:init]                         // User Component는 이 Override를 아직 허용하지 않음
    _pComplexComponent._onInitStatus = function ()
    {
        // status init logic             
    };
    /*
    // [object.status:onchange]                     // User Component는 이 Override를 아직 허용하지 않음
    _pComplexComponent._onChangeUserStatus = function (status, value)
    {
        // status change logic
    };
    // [object.logic:statuschange]                  // User Status는 사용자 로직에서 _changeUserStatus 호출로 처리
    ...
    */
    ...
    //  if (this._is_child)
        {
            // TODO : set_status 대신 changestatus 공통함수로 변경할것
