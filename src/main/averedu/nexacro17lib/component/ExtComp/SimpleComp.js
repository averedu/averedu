...
if (!nexacro.SimpleComponent)
{
    ...
    */
    ...
    {
        this._initNormalStyleProprty(this._control_element); // TODO: 소스통합
    };
    ...
    */
    ...
    _pSimpleComponent._applyProperties = function ()
    {
        ...
        if (this.positionstep)
            this.on_apply_positionstep(this.positionstep);  // TODO:argument 삭제
        if (this._hittest_type)
            this.on_apply_hittesttype(this._hittest_type);  // TODO:argument 삭제
        /*
  	    if (this.stock_prop1)
