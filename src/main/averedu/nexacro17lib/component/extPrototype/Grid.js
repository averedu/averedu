...
*  2017.10.18     	soojeong  	           multisort 오류 수정
*  2017.10.19		soojoeng			   찾기/바꾸기 기능 추가
*  2017.10.30       soojoeng			   그리드기능추가 및 스크립트정비
*******************************************************************************
*/
...
//	var sStatus = this.gfnGetWord("cmm.status");// 상태
	var sNo = this.gfnGetWordByID("cmm.no");		// 순번
	var sStatus = this.gfnGetWordByID("cmm.status");// 상태
...
//		var sDelete = nexacro.wrapQuote(this.gfnGetWord("delete")); //삭제
		var sExpr = "expr:"
				  + "dataset.getRowType(currow)==2?"+"'theme://images/img_WF_C.png'"
				  + ":dataset.getRowType(currow)==4?"+"'theme://images/img_WF_U.png'"
				  + ":dataset.getRowType(currow)==8?"+"'theme://images/img_WF_D.png'"
				  + ":''";
...
//		objGrid.setCellProperty("body", nBodyColIndex, "displaytype", "expr:dataset.getRowType(currow) != 1 ? 'text' : ''");
		objGrid.setCellProperty("body", nBodyColIndex, "displaytype", "expr:dataset.getRowType(currow) != 1 ? 'imagecontrol' : ''");
		objGrid.setCellProperty("body", nBodyColIndex, "text", sExpr);		
		objGrid.setCellProperty("body", nBodyColIndex, "textAlign","center");
		objGrid.setCellProperty("body", nBodyColIndex, "verticalAlign","middle");
		objGrid.mergeContentsCell("head", 0, nBodyColIndex, nHeadCount, nBodyColIndex, nHeadColIndex, false);	
		objGrid.mergeContentsCell("body", 0, nBodyColIndex, nBodyCount, nBodyColIndex, nBodyColIndex, false);			
...
//	var sTitle = this.gfnGetWord("popup.datafiltersetting");
	var sTitle = this.gfnGetWordByID("popup.datafiltersetting");	
...
//	var sTitle = this.gfnGetWord("popup.datafindreplace");
	var sTitle = this.gfnGetWordByID("popup.datafindreplace");
...
//	var sTitle = this.gfnGetWord("popup.colshwohide");
	var sTitle = this.gfnGetWordByID("popup.colshwohide");
...
pForm._gfnGridPersonalizeExcute = function (objGrid)
{
	...
	this.gfnAlertM("msg.save.success","","saveSuccess","gfnGridFormatChangeMsgCallback");
};
//////////////////////////////////////////////////////////////////////////POPUPMENU CALLBACK///////////////////////////////////////////////////////////
