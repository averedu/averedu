 ...
 */ 
pForm.gfnTransaction = function(strSvcId, strSvcUrl, inData, outData, strArg, callBackFnc, isAsync, dataType)
{
	...
	if(errorCode != 0)
	{
		switch(errorCode)
		{
			case -1 :				
				...
				// 서버 오류입니다.\n관리자에게 문의하세요.
				this.gfnAlertM("msg.server.error");
				break;
