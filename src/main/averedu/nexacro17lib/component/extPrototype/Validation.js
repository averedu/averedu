...
*  2017.11.14     	kyk  	               Validation 등록 방식을 User property에서 
                                           script 방식으로 변경
*******************************************************************************
*/
			...
			for(var j=0;j<validlist.length;j++)
			{
				...
				if (nullcheck == true)
				{
					if (this.gfnIsNull(columvalue))
					{
						...
						this.gfnAlertM("msg.err.validator.required", [titile], null, "gfnValidationCallback");
				...
				if (!this.gfnIsNull(columvalue))
				{
					...
					for(var k=0;k<checklist.length;k++)
					{
						...
						if (!this.gfnIsNull(msg))
						{
							...
							// 메시지 처리 : ${}
							this.gfnAlertM("msg.err.validator", [msg], null, "gfnValidationCallback");
