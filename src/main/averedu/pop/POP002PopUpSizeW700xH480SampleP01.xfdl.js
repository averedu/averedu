(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("사용자팝업(700x480)");
            ...
            obj = new Grid("grdMaster","20","156","661","259",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"70\"/><Column size=\"56\"/><Column size=\"244\"/><Column size=\"169\"/><Column size=\"65\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No.\"/><Cell col=\"1\" text=\"화면ID\"/><Cell col=\"2\" text=\"PREFIX\"/><Cell col=\"3\" text=\"FORMID\"/><Cell col=\"4\" text=\"FORM명(한글)\"/><Cell col=\"5\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\" textAlign=\"center\" edittype=\"none\"/><Cell col=\"1\" text=\"bind:PROG_ID\" displaytype=\"text\" edittype=\"none\"/><Cell col=\"2\" text=\"bind:FORM_PATH\" displaytype=\"combotext\" edittype=\"none\" combodataset=\"dsGPrefix\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"3\" text=\"bind:FORM_ID\" displaytype=\"text\" edittype=\"none\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:FORM_NM\" displaytype=\"text\" edittype=\"none\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:USER_YN\" displaytype=\"combotext\" edittype=\"none\" combodataset=\"dsGUseYn\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btnClose","567","434","55","26",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("닫기");
            obj.set_cssclass("btn_WF_Pop");
            this.addChild(obj.name, obj);

            obj = new Div("divSearch","19","50","662","71",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_cssclass("div_WF_SearchBox");
            this.addChild(obj.name, obj);

            obj = new Button("btnSearch",null,"40","55","22","9",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("조회");
            obj.set_cssclass("btn_WF_Search");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staSubTitle01","0","10","81","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("화면아이디");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtProgId","89","10","147","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_imemode("alpha");
            obj.set_inputmode("upper");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staSubTitle02","237","10","68","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("PREFIX");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboPrefix","310","10","103","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            ...
            obj = new Static("staSubTitle05","413","10","70","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboUserYn","489","10","98","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Static("staSubTitle03","0","37","81","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("FORM_ID");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtFormId","89","37","147","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_imemode("alpha");
            obj.set_inputmode("upper");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staSubTitle04","236","37","68","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("FORM명");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtFormNm","309","37","279","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_imemode("alpha");
            obj.set_inputmode("upper");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("Static34","440","32","100","5",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("5");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static35","440","59","100","10",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("staRowCnt","21","129",null,"24","548",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("[총 <fc v=\'red\'><b v=\'true\'>0 </b></fc>건]");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);

            obj = new Button("btnConfirm","626","434","55","26",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("확인");
            obj.set_cssclass("btn_WF_Pop");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnExit","649","19","32","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Static("Static05",null,"20","20",null,"-1","20",null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("20");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static06","20",null,null,"20","19","46",null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("20");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static00","335","121","50","35",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("35");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static02","20","121","100","15",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("15");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static10","20","149","100","7",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("7");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new BindItem("item1","divSearch.form.cboPrefix","value","ds_input","FORM_PATH");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearch.form.cboUserYn","value","ds_input","USER_YN");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divSearch.form.edtFormId","value","ds_input","FORM_ID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("POP002PopUpSizeW700xH480SampleP01.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.edtFormId.addEventHandler("onkeydown",this.divSearch_edtFormId_onkeydown,this);
        ...
        this.loadIncludeScript("POP002PopUpSizeW700xH480SampleP01.xfdl");
