(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("사용자팝업(480x300)");
            ...
            obj = new Grid("grdMaster","19","127","441","107",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("staSubTitle01","1","10","82","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("화면아이디");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtProgId","89","10","92","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_imemode("alpha");
            obj.set_inputmode("upper");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staSubTitle04","182","10","66","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("FORM명");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtFormNm","258","10","111","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_imemode("alpha");
            obj.set_inputmode("upper");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static01","250","0","100","10",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("10");
            ...
            obj = new Static("Static00","250","31","100","10",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("10");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("staRowCnt","19","100","65","22",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("[총 <fc v=\'red\'><b v=\'true\'>0 </b></fc>건]");
            obj.set_usedecorate("true");
            this.addChild(obj.name, obj);

            obj = new Button("btnConfirm","405","254","55","26",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("확인");
            obj.set_cssclass("btn_WF_Pop");
            this.addChild(obj.name, obj);

            obj = new Static("staTitle","20","19","152","22",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("화면관리팝업");
            obj.set_cssclass("sta_WF_Title01");
            this.addChild(obj.name, obj);

            obj = new Button("btnExit","424","19","36","31",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Static("Static09","289","20","76","30",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("30");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static02","460","20","20",null,null,"20",null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("20");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
            ...
            obj = new Static("Static05","20","93","100","15",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("15");
            obj.set_cssclass("sta_GU_space");
            obj.set_visible("false");
        ...
        // User Script
        this.registerScript("POP004PopUpSizeW480xH300SampleP01.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): POP004PopUpSizeW480xH300SampleP01.xfdl(화면관리팝업)
        * 작 성			일 명: jiback
        * 작 성	    	일 자: 2018/09/17
        * 변 경     	일 자:
        * 변 경			자 명:
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("POP004PopUpSizeW480xH300SampleP01.xfdl");
