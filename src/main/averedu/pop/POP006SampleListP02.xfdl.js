(function()
{
    return function()
    {
        ...
        {
            this.set_name("form");
            this.set_titletext("화면관리팝업(모덜러스테스트)");
        ...
        // User Script
        this.registerScript("POP006SampleListP02.xfdl", function() {
        /**********************************************************************
        ...
        ***********************************************************************/
        ...
        {
        	this.opener.fn_popupCallback(this.getOwnerFrame().svcId, "CLOSE");
        	this.close();
        };

        this.btnExit_onclick = function(obj,e)
        {
        	this.opener.fn_popupCallback(this.getOwnerFrame().svcId, "EXIT");
        	this.close();
        };
        /**********************************************************************
        	07.Get, Set Method
        ***********************************************************************/
        ...
        this.selDataSet = function(dsobj,nRow)
        {
        	if(this.sOptinoArg3 == "S")
        	{
        		...
        		this.opener.fn_popupCallback(this.getOwnerFrame().svcId, objRtnArr.toString());
        		this.close();
        	}else
        	{
        		var odsObj = this.all[dsobj];
        ...
        ***********************************************************************/
        ...
        this.loadIncludeScript("POP006SampleListP02.xfdl");
