(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_updatecontrol("true");
            obj.set_useclientlayout("false");
            obj._setContents("<ColumnInfo><Column id=\"CHK\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_CD\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_ABBR_NM\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<ColumnInfo><Column id=\"DEPT_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DEPT_NM\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdMaster","19","128","636","339",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"37\"/><Column size=\"48\"/><Column size=\"62\"/><Column size=\"270\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"No.\"/><Cell col=\"2\" text=\"부서코드\"/><Cell col=\"3\" text=\"부서명\"/><Cell col=\"4\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell text=\"bind:CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" editmaxlength=\"1\"/><Cell col=\"1\" expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\" textAlign=\"center\" edittype=\"none\"/><Cell col=\"2\" text=\"bind:DEPT_CD\"/><Cell col=\"3\" text=\"bind:DEPT_NM\" displaytype=\"text\" edittype=\"none\" textAlign=\"left\"/><Cell col=\"4\" text=\"bind:USE_YN\" displaytype=\"combotext\" edittype=\"none\" combodataset=\"dsUseYn\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("0");
            obj.set_text("부서 코드/명");
            obj.set_cssclass("sta_WF_SearchLbl");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtDeptId","97","10","453","22",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new BindItem("item0","divSearch.form.edtDeptId","value","ds_input","DEPT_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.loadPreloadList = function()
        {
            ...
            this._addPreloadList("data","","dsDept");
        };
        
        // User Script
        this.registerScript("POP101DeptSearchP01.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): POP101DeptSearchP01.xfdl(부서검색팝업)
        * 작 성			일 명: bsoh
        * 작 성	    	일 자: 2021/02/01
        * 변 경     	일 자:
        * 변 경			자 명:
        ...
        ***********************************************************************/
        this.fn_formInit = function()
        {
        	...
        	{
        		this.grdMaster.setFormatColProperty(0,"size",0)
        	}
        ...
        this.postformInit = function()
        {
        	...
        	this.ds_input.setColumn(0,"DEPT_NM", 	null);

        	var sSetComponet = this.sOptinoArg1;
        	var sAutoSearch  = this.sOptinoArg2;

        	// 설정에 따라서 호출 창으로부터 파라미터를 넘겨받는다.
        	this.divSearch.form.edtDeptId.setFocus();

        	if(sSetComponet == "Y")
        	{
        		this.ds_input.setColumn(0,"DEPT_NM",	this.sParamArg1);
        	}
        ...
        ***********************************************************************/
        ...
        this.postSearch = function()
        {
        	...
        	this.gfn_getRowCount(this.staRowCnt,this.dsDept);
        ...
        ***********************************************************************/
        ...
        this.selDataSet = function(dsobj,nRow)
        {
        	if(this.sOptinoArg3 == "S")
        	{
        		...
        		objRtnArr[1] = ds.getColumn(ds.rowposition, "DEPT_CD");
        		objRtnArr[2] = ds.getColumn(ds.rowposition, "DEPT_NM");
        ...
        ***********************************************************************/
        ...
        this.grdMaster_oncelldblclick = function(obj,e)
        {
        	if(this.sOptinoArg3 == "S")
        	{
        		this.selDataSet(obj.binddataset, this.dsDept.rowposition);
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.edtDeptId.addEventHandler("onkeydown",this.divSearch_edtProgId_onkeydown,this);
        ...
        this.loadIncludeScript("POP101DeptSearchP01.xfdl");
