(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnPostcode00","264","20","186","39",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("검색 API 우편번호 조회");
        ...
        // User Script
        this.registerScript("jusoapisearchpop.xfdl", function() {
        this.formType = "";
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.btnPostcode00.addEventHandler("onclick",this.btnPostcode_onclick,this);
        };
        this.loadIncludeScript("jusoapisearchpop.xfdl");
