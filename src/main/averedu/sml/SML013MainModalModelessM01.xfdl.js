(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"108\"/><Column size=\"164\"/><Column size=\"75\"/><Column size=\"157\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No.\"/><Cell col=\"1\" text=\"화면ID\"/><Cell col=\"2\" text=\"FORM명(한글)\"/><Cell col=\"3\" text=\"PREFIX\"/><Cell col=\"4\" text=\"FORMID\"/><Cell col=\"5\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell expr=\"expr:(dataset.getRowType(currow)) == &apos;2&apos; ? &apos;+&apos;:(dataset.getRowType(currow)) == &apos;4&apos; ? &apos;U&apos;:currow+1\" textAlign=\"center\" edittype=\"none\"/><Cell col=\"1\" text=\"bind:PROG_ID\" displaytype=\"normal\" edittype=\"text\" expandshow=\"show\" expandsize=\"30\" expandimage=\"url(&apos;theme://images/btn_WF_PopSrch.png&apos;)\" editautoselect=\"true\"/><Cell col=\"2\" text=\"bind:FORM_NM\" displaytype=\"text\" edittype=\"none\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:FORM_PATH\" displaytype=\"combotext\" edittype=\"none\" combodataset=\"dsGPrefix\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/><Cell col=\"4\" text=\"bind:FORM_ID\" displaytype=\"text\" edittype=\"none\"/><Cell col=\"5\" text=\"bind:USER_YN\" displaytype=\"combotext\" edittype=\"none\" combodataset=\"dsGUseYn\" combocodecol=\"CODE\" combodatacol=\"CODE_NM\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","edtCodeId","value","ds_input","PROG_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","edtCodeNm","value","ds_input","FORM_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("SML013MainModalModelessM01.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        *  @MenuPath
        ...
        ************************************************************************************************/
        ...
        this.loadIncludeScript("SML013MainModalModelessM01.xfdl");
