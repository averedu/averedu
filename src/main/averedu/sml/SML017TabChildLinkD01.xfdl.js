(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("TABCHILDTAB");
            ...
            obj = new Grid("Grid00","19","62",null,null,"19","30",null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("Button00",null,"21","40","30","71",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("+");
            this.addChild(obj.name, obj);

            obj = new Button("Button01",null,"21","40","30","23",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("-");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        this.loadIncludeScript("SML017TabChildLinkD01.xfdl");
