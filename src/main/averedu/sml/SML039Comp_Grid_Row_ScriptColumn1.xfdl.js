(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents("<ColumnInfo><Column id=\"CITY\" type=\"STRING\" size=\"256\"/><Column id=\"CITY_NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Grid("grd_output","15","76","775","301",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new GroupBox("GroupBox00","356","387","434","208",null,null,null,null,null,null,this);
            obj.set_text(" 설명 ");
            obj.set_taborder("2");
            ...
            obj.set_taborder("3");
            obj.set_text("데이터를 크로스탭으로 구성한 후 createFormat 메소드로 \r\nDataset의 칼럼 정보를 기준으로 Grid 포맷을 만들고\r\nappendContentsRow, deleteContentsCol, \r\nsetCellProperty, setFormatColProperty \r\n등의 메소드를 이용하여 Grid 포맷을 동적으로 구성함\r\n\r\n※ 왼쪽 Grid의 데이터를 상단 Grid처럼 행과 열을 교차시켜 \r\n데이터를 집계하는 크로스탭(엑셀의 피봇) 형태로 구성함");
            ...
            obj = new Button("btn_execute","15","40","91","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
        ...
        // User Script
        this.registerScript("SML039Comp_Grid_Row_ScriptColumn1.xfdl", function() {
        ...
        this.fn_crossTab = function()
        {
        	...
        	var strTmp   = "";
        	var nSum     = 0;
        	var sMaxYEAR = this.ds_data0.getMax("YEAR");
        	var sMinYEAR = this.ds_data0.getMin("YEAR");
        	...
        	this.ds_data1.addColumn("CITY_SUM", "BIGDECIMAL", 255);
        	this.ds_data1.addColumn("CITY_AVG", "BIGDECIMAL", 255);
        	...
        	for (var i = 0; i < this.ds_data0.rowcount; i++)
        	{
        		if (this.ds_data0.getColumn(i,"CITY") != strTmp)
        		{
        			...
        			this.ds_data1.setColumn(nAddRow, "C_" + this.ds_data0.getColumn(i, "YEAR"), this.ds_data0.getColumn(i, "VALUE"));
        		...
        		{
        			nSum = Number(this.fn_Trim(this.ds_data1.getColumn(nAddRow, "C_" + this.ds_data0.getColumn(i,"YEAR"))))
         			     + Number(this.ds_data0.getColumn(i, "VALUE"));
        			nSum = nexacro.round(nSum, 2);
        			this.ds_data1.setColumn(nAddRow, "C_" + this.ds_data0.getColumn(i, "YEAR"), nSum);
        		}
        	...
        	this.grd_output.deleteContentsCol(0);
        	this.grd_output.setFormatColProperty(0, "size", 100);
        	this.grd_output.setFormatColProperty(0, "band", "left");
         	this.grd_output.setCellProperty("Head", 0, "text", "CITY");
            this.grd_output.setCellProperty("Head", this.grd_output.getCellCount("Head") - 2, "text", "SUM");
            this.grd_output.setCellProperty("Head", this.grd_output.getCellCount("Head") - 1, "text", "AVG");
            this.grd_output.setFormatColProperty(this.grd_output.getCellCount("Head") - 2, "band", "right");
            this.grd_output.setFormatColProperty(this.grd_output.getCellCount("Head") - 1, "band", "right");
            this.grd_output.setCellProperty("Body", 0, "celltype", "head");
            this.grd_output.setCellProperty("Body", this.grd_output.getCellCount("Head") - 2, "celltype", "head");
            this.grd_output.setCellProperty("Body", this.grd_output.getCellCount("Head") - 1, "celltype", "head");
        	this.grd_output.appendContentsRow("summ");
        	this.grd_output.appendContentsRow("summ");
            this.grd_output.setCellProperty("Summ", 0, "text", "SUM");
            this.grd_output.setCellProperty("Summ", this.grd_output.getCellCount("Head"), "text", "AVG");
        	...
        	for (var i = sMaxYEAR; i >= sMinYEAR; i--)
        	{
        		if (this.ds_data0.findRow( "YEAR", i) > -1)
        		{
                    this.grd_output.setCellProperty( "Head", nJ  , "text",  this.grd_output.getCellText(-1, nJ).substr(2));
                    this.grd_output.setCellProperty( "Body", nJ  , "align", "right");
                    this.grd_output.setCellProperty( "Summ", nJ  , "align", "right");
                    this.grd_output.setCellProperty( "Summ", nK  , "align", "right");
        ...
        this.loadIncludeScript("SML039Comp_Grid_Row_ScriptColumn1.xfdl");
