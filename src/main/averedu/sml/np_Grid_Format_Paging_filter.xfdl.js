(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_execute","grd_output:7","40","90","30",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Grid("Grid00","grd_output:170","41","92","68",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj._setContents("");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("np_Grid_Format_Paging_filter.xfdl", function() {
        /*
        ...
        this.fn_makePage = function()
        {
        	...
        	var objDiv = new Div;
        	objDiv.init("divPage", "absolute", 85, 327, 330, 30, null, null);
        ...
        this.fn_getObjButton = function(sId, nLeft, nTop, nWidth, nBottom, sData, sText, nTab)
        {
        	...
        	objBtn.init(sId, "absolute", nLeft, nTop, nWidth, nBottom, null, null);
        ...
        this.loadIncludeScript("np_Grid_Format_Paging_filter.xfdl");
