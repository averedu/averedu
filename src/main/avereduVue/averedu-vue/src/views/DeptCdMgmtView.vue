      ...
      <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
        ...
        <div class="flex-1 overflow-y-auto">
          <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6">
              ...
              <div class="bg-white dark:bg-[#252731] h-32 p-6 rounded-lg shadow-md md:col-span-1">
                <label class="p-1">부서명<input @keyup.enter="search()" v-model="param.deptNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900" /></label>
                <label class="p-1">부서코드<input @keyup.enter="search()" v-model="param.deptCd" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900" /></label>
                <label class="p-1">부서ID<input @keyup.enter="search()" v-model="param.deptId"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900" /></label>
                <label class="p-1">
                  사용여부
                  <select @change="search()" v-model="param.useYn"
                    class="mx-3 p-1 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500">
                    <option selected></option>
                    <option value="Y">사용</option>
                    <option value="N">미사용</option>
                  </select></label><br>
                <label class="p-1">기관구분
                  <select @change="search()" v-model="param.breuFg"
                    class="mx-3 p-1 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500">
                    <option selected></option>
                    <option value="Y">사용</option>
                    <option value="N">미사용</option>
                ...
                <label class="p-1">최종조직여부
                  <select @change="search()" v-model="param.flDeptYn"
                    class="mx-3 p-1 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500">
                    <option selected></option>
                    <option value="Y">사용</option>
                    <option value="N">미사용</option>
                  </select></label>
                <label class="p-1">학사조직여부
                  <select @change="search()" v-model="param.shafFormaYn"
                    class="mx-3 p-1 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500">
                    <option selected></option>
                    <option value="Y">사용</option>
                    <option value="N">미사용</option>
                  </select></label>
                <button @click="search()" id="searchBtn" type="button"
                  class="float-right text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5
            ...
            <div
              ...
              <h2 class="text-xl font-semibold leading-tight text-gray-700">부서목록</h2><br>
              <div class="flex-auto w-2/4">
                <ag-grid-vue :columnDefs="mainColumnDefs" :rowData="mainRowData" @cell-clicked="onCellClicked"
                  @grid-ready="onGridReady" :gridOptions="gridOptions" style="width: 72%; height: 600px;"></ag-grid-vue>
           ...
           h-2/3 float-right relative" style="top: -640px; left: -2%; width: 60%; height: 50%;">
                <h1>부서정보
                  ...
                  <div class="float-right">
                    <ButtonTest @add-row="mainGridAdd()" @delete-item="deleteItemMain" @save-data="saveDataMain"
                      @download-excel="downloadExcelMain" />
                  </div>
                </h1><br><br>
                <label class="p-1">부서코드<input v-model="deptDetaInfo.deptCd" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
                <label class="p-1">상위부서<input v-model="deptDetaInfo.upDeptCd" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
                <label class="p-1">사용여부<input v-model="deptDetaInfo.useYn" type="checkbox"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-8" /></label><br>

                <label class="p-1">기관구분<select name="" v-model="deptDetaInfo.breuFg"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32">
                    <option value=""></option>
                    <option value="Y">기관</option>
                    <option value="N">미기관</option>
                  </select></label>
                <label class="p-1">조직유형<select name="" v-model="deptDetaInfo.formaTyp"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32">
                    <option value=""></option>
                    <option value="Y">조직</option>
                    <option value="N">미조직</option>
                  </select></label>
                <label class="p-1">학사조직여부<input v-model="deptDetaInfo.shafFormaYn" type="checkbox"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-8" /></label><br>
                <label class="p-1">부서명<input v-model="deptDetaInfo.deptNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32" /></label>
                <label class="p-1">부서약어명<input v-model="deptDetaInfo.deptAbbnm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32" /></label>
                <label class="p-1">가상조직여부<input v-model="deptDetaInfo.cyberFormaYn" type="checkbox"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-8" /></label><br>
                <label class="p-1">부서영문명<input v-model="deptDetaInfo.deptEngNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
                <label class="p-1">부서영문약어명<input v-model="deptDetaInfo.deptEngAbbNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
                <label class="p-1">최종조직여부<input v-model="deptDetaInfo.flDeptYn" type="checkbox"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-8" /></label><br>
                <label class="p-1">부서중문명<input v-model="deptDetaInfo.deptChnNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
                <label class="p-1">부서중문약어명<input v-model="deptDetaInfo.deptChnAbbNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
                <label class="p-1">부서ID<input v-model="deptDetaInfo.deptId" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32" /></label><br>
                <label class="p-1">생성일자<input v-model="deptDetaInfo.frDt" type="date"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32" /></label>
                <label class="p-1">대학(처)<input v-model="deptDetaInfo.colgNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32" /></label>
                <label class="p-1">주야구분<select name="" v-model="deptDetaInfo.danFg"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32">
                    <option value=""></option>
                    <option value="Y">주간</option>
                    <option value="N">야간</option>
                  </select></label><br>
                <label class="p-1">폐지일자<input v-model="deptDetaInfo.ablnDt" type="date"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32" /></label>
                <label class="p-1">학부(팀)<input v-model="deptDetaInfo.sustTeamNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32" /></label>
                <label class="p-1">부서정렬순번<input v-model="deptDetaInfo.deptSortSeq" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label><br>
                <label class="p-1">폐지예정일자<input v-model="deptDetaInfo.ablnExpcDt" type="date"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32" /></label>
                <label class="p-1">부총장조직코드<select name="" v-model="deptDetaInfo.subChancMissCd"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24">
                    <option value=""></option>
                    <option value="Y">기관</option>
                    <option value="N">미기관</option>
                  </select></label>
                <label class="p-1">비고<input v-model="deptDetaInfo.remk" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
              </div>
          ...
          h-2/3 float-right relative" style="top: -640px; left: -30px; width: 60%; height: 50%;">
                <h1>부서코드 연계정보</h1><br>
                <label class="p-1">증명서부서명<input v-model="deptDetaInfo.certDeptNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
                <label class="p-1">주간학과코드<input v-model="deptDetaInfo.daytmSustCd" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
                <label class="p-1">정보공시계열<select name="" v-model="deptDetaInfo.infoAnncPart"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24">
                    <option value=""></option>
                    <option value="Y">기관</option>
                    <option value="N">미기관</option>
                  </select></label><br>
                <label class="p-1">학사학위<select name="" v-model="deptDetaInfo.shafDegr"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32">
                    <option value=""></option>
                    <option value="Y">학사</option>
                    <option value="N">미학사</option>
                  </select></label>
                <label class="p-1">석사학위<select name="" v-model="deptDetaInfo.masterDegr"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32">
                    <option value=""></option>
                    <option value="Y">석사</option>
                    <option value="N">미석사</option>
                  </select></label>
                <label class="p-1">박사학위<select name="" v-model="deptDetaInfo.phdDegr"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32">
                    <option value=""></option>
                    <option value="Y">박사</option>
                    <option value="N">미박사</option>
                  </select></label><br>
                <label class="p-1">전공분류<select name="" v-model="deptDetaInfo.mjClsf"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32">
                    <option value=""></option>
                    <option value="Y">전공</option>
                    <option value="N">미전공</option>
                  </select></label>
                <label class="p-1">연계전공<input v-model="deptDetaInfo.connMj" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32" /></label>
                <label class="p-1">업적계열<select name="" v-model="deptDetaInfo.achvPart"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32">
                    <option value=""></option>
                    <option value="Y">업적</option>
                    <option value="N">미업적</option>
                  </select></label><br>
                <label class="p-1">등록계열<input v-model="deptDetaInfo.regPart" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32" /></label>
                <label class="p-1">졸업학위증출력명<input v-model="deptDetaInfo.grdtDegrIdcdPrnNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
                <label class="p-1">수업년한<input v-model="deptDetaInfo.lsnYr" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label><br>
                <label class="p-1">업적심사대학<select name="" v-model="deptDetaInfo.achvScrnUniv"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32">
                    <option value=""></option>
                    <option value="Y">업적심사</option>
                    <option value="N">미심사</option>
                  </select></label>
                <label class="p-1">대학원분류<select name="" v-model="deptDetaInfo.grscClsf"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-32">
                    <option value=""></option>
                    <option value="Y">분류</option>
                    <option value="N">미분류</option>
                  </select></label>
                <label class="p-1">학부(과)<input v-model="deptDetaInfo.sustNm" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label><br>
                <label class="p-1">그룹웨어부서연계여부<input v-model="deptDetaInfo.gwDeptConnYn" type="checkbox"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-8" /></label>
                <label class="p-1">교원그룹웨어부서코드<input v-model="deptDetaInfo.sprfGwDeptCd" type="text"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label><br>
                <label class="p-1">직원그룹웨어부서코드<input v-model="deptDetaInfo.empGwDeptCd" type="check"
                    class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 w-24" /></label>
              </div>
              <div class="bg-white dark:bg-[#252731] h-32 p-6 rounded-lg shadow-md md:col-span-1  text-1xl font-semibold mb-4 text-gray-800 dark:text-white flex-auto w-2/4
          h-2/3 float-right relative" style="top: -640px; left: -30px; width: 60%; height: 50%;">
                <h1>부서이력목록&nbsp;&nbsp;<b class="text-sm font-light">* 부서가 통·폐합되거나 명칭 변경 등으로 신규 부서를 등록한
                    경우<br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                    이력 관리를 위해 부서 이력 목록을 등록해주십시오.</b><br>
                  <strong class="float-right">총 : {{ subRowData.length }} 건</strong>
                  <div class="float-right">
                    <ButtonTest @add-row="subGridAdd()" @delete-item="deleteItemMain" @save-data="saveDataMain"
                      @download-excel="downloadExcelMain" />
                  </div>
                </h1><br><br><br>
                <ag-grid-vue :columnDefs="subColumnDefs" :rowData="subRowData" :gridOptions="gridOptions"
                  style="width: 100%; height: 150px;"></ag-grid-vue>
              </div>
            </div>
          </div>
        </div>
