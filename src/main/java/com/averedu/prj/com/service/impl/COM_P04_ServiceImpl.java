...
import com.averedu.prj.com.dao.COM_P04_DAO;                                                                             
import com.averedu.prj.com.service.COM_P04_Service;                                                                        
import egovframework.rte.cmmn.ria.nexacroplatform.NexacroPlatformConstant;                                                   
import egovframework.rte.cmmn.ria.nexacroplatform.map.DataSetMap;                                                            
import egovframework.rte.fdl.cmmn.EgovAbstractServiceImpl;                                                                   
                                                                                                                             
@Service("COM_P04_Service")                                                                               
public class COM_P04_ServiceImpl extends EgovAbstractServiceImpl implements COM_P04_Service {                  
    protected Log log = LogFactory.getLog(this.getClass()); 	                                                                
                                                                                                                             
    /** COM_P04_DAO */                                                                                             
    @Resource(name="COM_P04_DAO")                                                                      
    private COM_P04_DAO com_P04_DAO;                                                                     
    ...
    public void retrieve_P04( Map<String, Object> inVar, Map<String, DataSetMap> inDataset,                     
        ...
        List<Map> records = com_P04_DAO.retrieve_P04(map);                                            
