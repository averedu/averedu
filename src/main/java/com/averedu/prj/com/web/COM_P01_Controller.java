...
@Controller                                                                                                            		
public class COM_P01_Controller {                                                                                   		
                                                                                                                       		
	Log logger = LogFactory.getLog(this.getClass());                                                                  			
                                                                                                                       		
    /** COM_01_Service */                                                                                          	
    @Resource(name = "COM_P01_Service")                                                                     
    private COM_P01_Service com_P01_Service;                                                                     
                                                                                                                       		
    /**                                                                                                                		
	 * 부서리스트 조회 (actionRetrieve_01_)                                                             
	 * @param input                                                                                                 			
	 * @return                                                                                                      			
	 * @throws Exception                                                                                           				
	 */                                                                                                             			
	@RequestMapping(value = "/prj/com/Retrieve_P01.do")      
	public ModelAndView actionRetrieve_P01(NexacroPlatformMapDTO nxDto, Model model, HttpSession session)throws Exception {
	    ...
	    {                                                                                                           			
			...
			com_P01_Service.retrieve_P01(inVar, inDataset, outVar, outDataset, sessionVO);                  
