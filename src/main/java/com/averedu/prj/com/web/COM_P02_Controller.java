...
import com.averedu.prj.com.service.COM_P02_Service;                                                                         
import egovframework.rte.cmmn.ria.nexacroplatform.NexacroPlatformConstant;                                                     
import egovframework.rte.cmmn.ria.nexacroplatform.map.DataSetMap;                                                 				
import egovframework.rte.cmmn.ria.nexacroplatform.map.NexacroPlatformMapDTO;                                                   
                                                                                                                       		
@Controller                                                                                                            		
public class COM_P02_Controller {                                                                                   		
                                                                                                                       		
	Log logger = LogFactory.getLog(this.getClass());                                                                  			
                                                                                                                       		
    /** COM_P02_Service */                                                                                          	
    @Resource(name = "COM_P02_Service")                                                                     
    private COM_P02_Service com_P02_Service;                                                                     
                                                                                                                       		
    /**                                                                                                                		
	 * 기본인사(SDB_MA1000)리스트 조회 (actionRetrieve_P02_)                                                             
	 * @param input                                                                                                 			
	 * @return                                                                                                      			
	 * @throws Exception                                                                                           				
	 */                                                                                                             			
	@RequestMapping(value = "/prj/com/Retrieve_P02.do")      
	public ModelAndView actionRetrieve_P02(NexacroPlatformMapDTO nxDto, Model model, HttpSession session)throws Exception {
	    ...
	    {                                                                                                           			
			...
			com_P02_Service.retrieve_P02(inVar, inDataset, outVar, outDataset, sessionVO);                  
