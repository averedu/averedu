...
@Controller                                                                                                            		
public class COM_P06_Controller {                                                                                   		
                                                                                                                       		
	Log logger = LogFactory.getLog(this.getClass());                                                                  			
                                                                                                                       		
    /** COM_P06_Service */                                                                                          	
    @Resource(name = "COM_P06_Service")                                                                     
    private COM_P06_Service com_P06_Service;                                                                     
                                                                                                                       		
    /**                                                                                                                		
	 * 설문문항내역리스트 조회 (actionRetrieve_P06_)                                                             
	 * @param input                                                                                                 			
	 * @return                                                                                                      			
	 * @throws Exception                                                                                           				
	 */                                                                                                             			
	@RequestMapping(value = "/prj/com/Retrieve_P06.do")      
	public ModelAndView actionRetrieve_P06(NexacroPlatformMapDTO nxDto, Model model, HttpSession session)throws Exception {
	    ...
	    {                                                                                                           			
			...
			com_P06_Service.retrieve_P06(inVar, inDataset, outVar, outDataset, sessionVO);                  
