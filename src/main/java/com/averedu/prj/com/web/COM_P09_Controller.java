...
@Controller                                                                                                            		
public class COM_P09_Controller {                                                                                   		
                                                                                                                       		
	Log logger = LogFactory.getLog(this.getClass());                                                                  			
                                                                                                                       		
    /** COM_P09Service */                                                                                          	
    @Resource(name = "COM_P09_Service")                                                                     
    private COM_P09_Service com_P09_Service;                                                                     
                                                                                                                       		
    /**                                                                                                                		
	 * 자격증리스트 조회 (actionRetrieve_P09)                                                             
	 * @param input                                                                                                 			
	 * @return                                                                                                      			
	 * @throws Exception                                                                                           				
	 */                                                                                                             			
	@RequestMapping(value = "/prj/com/Retrieve_P09.do")      
	public ModelAndView actionRetrieve_P09(NexacroPlatformMapDTO nxDto, Model model, HttpSession session)throws Exception {
	    ...
	    {                                                                                                           			
			...
			com_P09_Service.retrieve_P09(inVar, inDataset, outVar, outDataset, sessionVO);                  
