...
import com.averedu.prj.com.service.COM_P12_Service;                                                                         
import egovframework.rte.cmmn.ria.nexacroplatform.NexacroPlatformConstant;                                                     
import egovframework.rte.cmmn.ria.nexacroplatform.map.DataSetMap;                                                 				
import egovframework.rte.cmmn.ria.nexacroplatform.map.NexacroPlatformMapDTO;                                                   
                                                                                                                       		
@Controller                                                                                                            		
public class COM_P12_Controller {                                                                                   		
                                                                                                                       		
	Log logger = LogFactory.getLog(this.getClass());                                                                  			
                                                                                                                       		
    /** COM_P12Service */                                                                                          	
    @Resource(name = "COM_P12_Service")                                                                     
    private COM_P12_Service com_P12_Service;                                                                     
                                                                                                                       		
    /**                                                                                                                		
	 * 입시접수정보 조회 (actionRetrieve_P12)                                                             
	 * @param input                                                                                                 			
	 * @return                                                                                                      			
	 * @throws Exception                                                                                           				
	 */                                                                                                             			
	@RequestMapping(value = "/prj/com/Retrieve_P12.do")      
	public ModelAndView actionRetrieve_P12(NexacroPlatformMapDTO nxDto, Model model, HttpSession session)throws Exception {
	    ...
	    {                                                                                                           			
			...
			com_P12_Service.retrieve_P12(inVar, inDataset, outVar, outDataset, sessionVO);                  
