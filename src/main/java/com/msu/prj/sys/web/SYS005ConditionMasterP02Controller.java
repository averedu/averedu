...
import com.msu.prj.sys.service.SYS005ConditionMasterP02Service;
...
@Controller
public class SYS005ConditionMasterP02Controller {

	Log logger = LogFactory.getLog(this.getClass());                                                                  			
		
    /** SYS005ConditionMasterService */                                                                                          	
    @Resource(name = "SYS005ConditionMasterP02Service")                                                                     
    private SYS005ConditionMasterP02Service sys005ConditionMasterP02Service;
	 ...
	 * @throws Exception                                                                                           				
	 */                                                                                                             			
	@RequestMapping(value = "/prj/sys/RetrieveConditionMasterP02List.do")      
	public ModelAndView retrieveConditionMasterP02List(NexacroPlatformMapDTO nxDto, Model model, HttpSession session)throws Exception {
	    ...
	    {                                                                                                           			
			...
			sys005ConditionMasterP02Service.retrieveConditionMasterP02List(inVar, inDataset, outVar, outDataset, sessionVO);                  
