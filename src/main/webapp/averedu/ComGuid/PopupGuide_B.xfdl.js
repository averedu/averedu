(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_134",null,"23","46","22","272",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);

            obj = new Button("btn_132",null,"23","46","22","320",null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("추가");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);

            obj = new Button("Button00",null,"104","46","22","260",null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("조회");
            this.addChild(obj.name, obj);

            obj = new Button("Button01",null,"104","46","22","212",null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("추가");
            this.addChild(obj.name, obj);

            obj = new Button("Button02",null,"104","46","22","164",null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("삭제");
            this.addChild(obj.name, obj);

            obj = new Button("Button03",null,"104","46","22","116",null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("저장");
            this.addChild(obj.name, obj);

            obj = new Button("Button04",null,"104","46","22","68",null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("엑셀");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_04",null,"23","46","22","20",null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("닫기");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("PopupGuide_B.xfdl");
