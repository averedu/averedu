(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("COMM000008D.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        *  @MenuPath    com > cmmPaging.xfdl (공통 페이징DIV)
        ...
        */
        ...
        {
        	//가운데로
        	if (this.fvFnCallback != "")
        	{
        		this.fnSetCenter(obj);
        	}
        };
        ...
        */
        this.fnCreatePage = function(sFnCallback, nTotalCount, nRecords, nPage, nPageCount)
        {
            ...
            if (this.gfn_isNull(sPageView))
        	{
        		sPageView 		= "all";
            }

        	if (this.gfn_isNull(nRecords))
        	{
        		nRecords 		= 50;
            }

        	if (this.gfn_isNull(nPage))
        	{
        		nPage 			= 0;
            }

        	if (this.gfn_isNull(nPageScaleC))
        	{
        		nPageScaleC 	= 10;
            }
           ...
           //다음페이지
            ...
            if (sPageView == "all" || sPageView == "number")
            {
        		...
        		objBtnFirst.set_cssclass("btn_WF_PagePrev2");
        		...
        		objBtnBefore.set_cssclass("btn_WF_PagePrev");
        		...
        		for(var i=uint; i<nextUnit; i++ )
        		{
        			...
        			if(i == nPage)
        			{
        				objBtnPage.set_cssclass("btn_WF_Page_S"); //누름표시
        			}
        			objBtnPage.show();
        		...
        		objBtnNext.set_cssclass("btn_WF_PageNext");
        		//objBtnNext.set_text(">");
        		...
        		if( nPage >= nTotalPageC)
        		{
        			objBtnNext.set_enable(false);
        		}
        		objBtnNext.show();
        		nLeft = nLeft + nWidth + nTermBtn; //left값 계산
        		...
        		objBtnEnd.set_cssclass("btn_WF_PageNext2");
        		//objBtnEnd.set_text(">>");
        ...
        */
        ...
        this.loadIncludeScript("COMM000008D.xfdl");
