(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnSetFilter","324","235","66","24",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("적용");
            obj.getSetter("uWord").set("popup.apply");
            this.addChild(obj.name, obj);

            obj = new Button("btnClose","392","235","66","24",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("닫기");
            obj.getSetter("uWord").set("popup.close");
            this.addChild(obj.name, obj);

            obj = new Static("staTitle","13","6","152","22",null,null,null,null,null,null,this);
            obj.set_taborder("6");
        ...
        // User Script
        this.registerScript("COMM000012P.xfdl", function() {
        /**
        *  컨설팅 표준화 작업
        *  @MenuPath        com > COMM000012P
        *  @FileName 		COMM000012P.xfdl
        *  @Creator 		jiback
        ...
        * FORM EVENT 영역(onload)
        ...
        this.form_onload = function(obj,e)
        {
            this.gfn_formOnload(obj.e);
         	...
         	var sTitle = this.getOwnerFrame().titletext;
        ...
        */
        this.btnFilterCancel_onclick = function(obj,e)
        {
        	...
        	{
        		this.dsFilter.setColumn(i,"filtertype","");
        		this.dsFilter.setColumn(i,"filtervalue","");
        	}
        };
        ...
        */
        this.btnDown_onclick = function(obj,e)
        {
            ...
            if( currow == this.dsFilter.getRowCount()-1 )
        	{
        		return false;
        	}
            this.dsFilter.moveRow(currow, ++currow);
        ...
        */
        ...
        {
        	if(e.cell == obj.getBindCellIndex("body","filtertype"))
        	{
        		obj.dropdownCombo();																	// 클릭시 바로 콤보를 펼치는 기능
        	}
        };

        this.dsFilter_oncolumnchanged = function(obj,e)
        {
        	if(e.columnid == "filtertype")
        	{
        		   this.grdList.setCellPos(this.grdList.getBindCellIndex("body","filtervalue"));
        	       this.grdList.showEditor(true);
        		   this.dsFilter.setColumn(e.row,"filtervalue","");
        	}
        };
        ...
        this.loadIncludeScript("COMM000012P.xfdl");
