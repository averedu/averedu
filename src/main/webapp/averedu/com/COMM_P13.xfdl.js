(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_updatecontrol("true");
            obj.set_useclientlayout("false");
            obj._setContents("<ColumnInfo><Column id=\"GYOGWAMOK_CD\" type=\"STRING\" size=\"10\"/><Column id=\"GYOGWAMOK_NM\" type=\"STRING\" size=\"200\"/><Column id=\"GYOGWAMOK_ENM\" type=\"STRING\" size=\"200\"/><Column id=\"GYOGWAMOK_GAEYO\" type=\"STRING\" size=\"1000\"/><Column id=\"GYOGWAMOK_GAEYO_ENM\" type=\"STRING\" size=\"1000\"/><Column id=\"HAKJEOM\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"IRON_TM\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"SILSEUP_TM\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"TONGHAP_TM\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"IRON_SISU\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"SILSEUP_SISU\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"TONGHAP_SISU\" type=\"BIGDECIMAL\" size=\"22\"/><Column id=\"ISU_GBCD\" type=\"STRING\" size=\"10\"/><Column id=\"ISU_GBNM\" type=\"STRING\" size=\"65532\"/><Column id=\"GWAMOK_GBCD\" type=\"STRING\" size=\"10\"/><Column id=\"GWAMOK_GBNM\" type=\"STRING\" size=\"65532\"/><Column id=\"NCS_GBCD\" type=\"STRING\" size=\"10\"/><Column id=\"NCS_NEUNGRYEOK_GBCD\" type=\"STRING\" size=\"10\"/><Column id=\"PYEONGGA_GBCD\" type=\"STRING\" size=\"10\"/><Column id=\"SEONGJEOK_BUYEO_GBCD\" type=\"STRING\" size=\"10\"/><Column id=\"GANGUISIL_GBCD\" type=\"STRING\" size=\"10\"/><Column id=\"SISU_HALF_GWAMOK_YN\" type=\"STRING\" size=\"1\"/><Column id=\"GYOJIKGWAMOK_YN\" type=\"STRING\" size=\"1\"/><Column id=\"GANGUIPYEONGGA_YN\" type=\"STRING\" size=\"1\"/><Column id=\"PO_YN\" type=\"STRING\" size=\"1\"/><Column id=\"GANGUIPYEONGGA_TYCD\" type=\"STRING\" size=\"10\"/><Column id=\"CHOICHO_GAESEOL_YYYY\" type=\"STRING\" size=\"4\"/><Column id=\"SINCHEONG_DT\" type=\"STRING\" size=\"8\"/><Column id=\"PYEJI_DT\" type=\"STRING\" size=\"8\"/><Column id=\"JUGWAN_DAEHAK_CD\" type=\"STRING\" size=\"10\"/><Column id=\"DAEHAK_NM\" type=\"STRING\" size=\"65532\"/><Column id=\"JUGWAN_HAKGWA_CD\" type=\"STRING\" size=\"10\"/><Column id=\"HAKGWA_NM\" type=\"STRING\" size=\"65532\"/><Column id=\"JUGWAN_JEONGONG_CD\" type=\"STRING\" size=\"10\"/><Column id=\"JEONGONG_NM\" type=\"STRING\" size=\"65532\"/><Column id=\"DEPT_NM\" type=\"STRING\" size=\"65532\"/><Column id=\"SEUNGIN_GBCD\" type=\"STRING\" size=\"10\"/><Column id=\"SINCHEONGJA_ID\" type=\"STRING\" size=\"30\"/><Column id=\"SEUNGINJA_ID\" type=\"STRING\" size=\"30\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"1\"/><Column id=\"GU_SYS_GYOGWAMOK_CD\" type=\"STRING\" size=\"10\"/><Column id=\"GYOYANG_GBCD\" type=\"STRING\" size=\"10\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("COMM_P13.xfdl", function() {
        /**********************************************************************
        * FormID(화면   ID명): COMM_P13.xfdl(교직과목 조회)
        * 작 성         일 명: 정진호
        * 작 성         일 자: 2022/08/19
        * 변 경         일 자:
        * 변 경         자 명:
        ...
        ***********************************************************************/
        ...
        this.btnChoice_onclick = function(obj,e)
        {
        	...
        	objRtnArr[6] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "IRON_TM");
        	objRtnArr[7] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "SILSEUP_TM");
        	objRtnArr[8] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "TONGHAP_TM");
        	objRtnArr[9] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "IRON_SISU");
        	objRtnArr[10] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "SILSEUP_SISU");
        	objRtnArr[11] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "TONGHAP_SISU");
        	objRtnArr[12] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "ISU_GBCD");
        	objRtnArr[13] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "ISU_GBNM");
        	objRtnArr[14] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "GWAMOK_GBCD");
        	objRtnArr[15] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "GWAMOK_GBNM");
        	objRtnArr[16] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "NCS_GBCD");
        	objRtnArr[17] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "NCS_NEUNGRYEOK_GBCD");
        	objRtnArr[18] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "PYEONGGA_GBCD");
        	objRtnArr[19] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "SEONGJEOK_BUYEO_GBCD");
        	objRtnArr[20] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "GANGUISIL_GBCD");
        	objRtnArr[21] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "SISU_HALF_GWAMOK_YN");
        	objRtnArr[22] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "GYOJIKGWAMOK_YN");
        	objRtnArr[23] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "GANGUIPYEONGGA_YN");
        	objRtnArr[24] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "PO_YN");
        	objRtnArr[25] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "GANGUIPYEONGGA_TYCD");
        	objRtnArr[26] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "CHOICHO_GAESEOL_YYYY");
        	objRtnArr[27] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "SINCHEONG_DT");
        	objRtnArr[28] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "PYEJI_DT");
        	objRtnArr[29]	= this.dsMaster.getColumn(this.dsMaster.rowposition, "JUGWAN_DAEHAK_CD");
        	objRtnArr[30] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "DAEHAK_NM");
        	objRtnArr[31] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "JUGWAN_HAKGWA_CD");
        	objRtnArr[32] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "HAKGWA_NM");
        	objRtnArr[33] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "JUGWAN_JEONGONG_CD");
        	objRtnArr[34] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "JEONGONG_NM");
        	objRtnArr[35] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "DEPT_NM");
        	objRtnArr[36] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "SEUNGIN_GBCD");
        	objRtnArr[37] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "SINCHEONGJA_ID");
        	objRtnArr[38] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "SEUNGINJA_ID");
        	objRtnArr[39] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "USE_YN");
        	objRtnArr[40] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "GU_SYS_GYOGWAMOK_CD");
        	objRtnArr[41] 	= this.dsMaster.getColumn(this.dsMaster.rowposition, "GYOYANG_GBCD");
        ...
        this.loadIncludeScript("COMM_P13.xfdl");
