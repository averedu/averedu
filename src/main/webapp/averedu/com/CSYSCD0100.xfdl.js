    ...
    return function()
    {
        ...
        */
        ...
        this.dsDetail_cancolumnchange = function(obj, e)
        {
        	...
        	{
        		var nRow = this.dsDetail.findRowExpr("LANG_FG_CD == '" + e.newvalue + "' && currow != '" +e.row+"'");
        		if(nRow > -1)
        		{
